...
int main(int argc, char **argv) {
  ...
  14:	1a2080e7          	jalr	418(ra) # 1b2 <atoi>
...
free(void *ap)
{
 ...
 66e:	1a67b783          	ld	a5,422(a5) # 810 <freep>
 ...
 69c:	00e6ea63          	bltu	a3,a4,6b0 <free+0x50>
{
 ...
 6de:	12f73b23          	sd	a5,310(a4) # 810 <freep>
}
 6e2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 710:	10453503          	ld	a0,260(a0) # 810 <freep>
 ...
 738:	0dc90913          	addi	s2,s2,220 # 810 <freep>
  if(p == (char*)-1)
 73c:	5afd                	li	s5,-1
 73e:	a88d                	j	7b0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 740:	00000797          	auipc	a5,0x0
 744:	0d878793          	addi	a5,a5,216 # 818 <base>
 748:	00000717          	auipc	a4,0x0
 74c:	0cf73423          	sd	a5,200(a4) # 810 <freep>
 750:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 772:	0aa73123          	sd	a0,162(a4) # 810 <freep>
      return (void*)(p + 1);
