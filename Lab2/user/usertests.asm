...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	b6250513          	addi	a0,a0,-1182 # 5ba0 <malloc+0x3ea>
      46:	00005097          	auipc	ra,0x5
      4a:	6b2080e7          	jalr	1714(ra) # 56f8 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	b4050513          	addi	a0,a0,-1216 # 5bc0 <malloc+0x40a>
      88:	00005097          	auipc	ra,0x5
      8c:	670080e7          	jalr	1648(ra) # 56f8 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	b3050513          	addi	a0,a0,-1232 # 5bd8 <malloc+0x422>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	b3250513          	addi	a0,a0,-1230 # 5bf8 <malloc+0x442>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	afa50513          	addi	a0,a0,-1286 # 5be0 <malloc+0x42a>
      ee:	00005097          	auipc	ra,0x5
      f2:	60a080e7          	jalr	1546(ra) # 56f8 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	b0650513          	addi	a0,a0,-1274 # 5c08 <malloc+0x452>
     10a:	00005097          	auipc	ra,0x5
     10e:	5ee080e7          	jalr	1518(ra) # 56f8 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	b0450513          	addi	a0,a0,-1276 # 5c30 <malloc+0x47a>
     134:	00005097          	auipc	ra,0x5
     138:	294080e7          	jalr	660(ra) # 53c8 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	af050513          	addi	a0,a0,-1296 # 5c30 <malloc+0x47a>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	aec58593          	addi	a1,a1,-1300 # 5c40 <malloc+0x48a>
     15c:	00005097          	auipc	ra,0x5
     160:	23c080e7          	jalr	572(ra) # 5398 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	ac850513          	addi	a0,a0,-1336 # 5c30 <malloc+0x47a>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	acc58593          	addi	a1,a1,-1332 # 5c48 <malloc+0x492>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	a9c50513          	addi	a0,a0,-1380 # 5c30 <malloc+0x47a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	a8650513          	addi	a0,a0,-1402 # 5c50 <malloc+0x49a>
     1d2:	00005097          	auipc	ra,0x5
     1d6:	526080e7          	jalr	1318(ra) # 56f8 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000278 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     294:	7c050513          	addi	a0,a0,1984 # 5a50 <malloc+0x29a>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a8:	7aca8a93          	addi	s5,s5,1964 # 5a50 <malloc+0x29a>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     32a:	95250513          	addi	a0,a0,-1710 # 5c78 <malloc+0x4c2>
     32e:	00005097          	auipc	ra,0x5
     332:	3ca080e7          	jalr	970(ra) # 56f8 <printf>
      exit(1);
     336:	4505                	li	a0,1
     ...
     34e:	94e50513          	addi	a0,a0,-1714 # 5c98 <malloc+0x4e2>
     352:	00005097          	auipc	ra,0x5
     356:	3a6080e7          	jalr	934(ra) # 56f8 <printf>
        exit(1);
     35a:	4505                	li	a0,1
...
0000000000000364 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     38a:	92aa0a13          	addi	s4,s4,-1750 # 5cb0 <malloc+0x4fa>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     436:	88650513          	addi	a0,a0,-1914 # 5cb8 <malloc+0x502>
     43a:	00005097          	auipc	ra,0x5
     43e:	2be080e7          	jalr	702(ra) # 56f8 <printf>
      exit(1);
     442:	4505                	li	a0,1
     ...
     454:	88050513          	addi	a0,a0,-1920 # 5cd0 <malloc+0x51a>
     458:	00005097          	auipc	ra,0x5
     45c:	2a0080e7          	jalr	672(ra) # 56f8 <printf>
      exit(1);
     460:	4505                	li	a0,1
     ...
     472:	89250513          	addi	a0,a0,-1902 # 5d00 <malloc+0x54a>
     476:	00005097          	auipc	ra,0x5
     47a:	282080e7          	jalr	642(ra) # 56f8 <printf>
      exit(1);
     47e:	4505                	li	a0,1
     ...
     48c:	8a850513          	addi	a0,a0,-1880 # 5d30 <malloc+0x57a>
     490:	00005097          	auipc	ra,0x5
     494:	268080e7          	jalr	616(ra) # 56f8 <printf>
      exit(1);
     498:	4505                	li	a0,1
     ...
     4aa:	89a50513          	addi	a0,a0,-1894 # 5d40 <malloc+0x58a>
     4ae:	00005097          	auipc	ra,0x5
     4b2:	24a080e7          	jalr	586(ra) # 56f8 <printf>
      exit(1);
     4b6:	4505                	li	a0,1
...
00000000000004c0 <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4e8:	88ca0a13          	addi	s4,s4,-1908 # 5d70 <malloc+0x5ba>
    n = write(fds[1], "x", 1);
     4ec:	00005a97          	auipc	s5,0x5
     4f0:	75ca8a93          	addi	s5,s5,1884 # 5c48 <malloc+0x492>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     596:	7e650513          	addi	a0,a0,2022 # 5d78 <malloc+0x5c2>
     59a:	00005097          	auipc	ra,0x5
     59e:	15e080e7          	jalr	350(ra) # 56f8 <printf>
      exit(1);
     5a2:	4505                	li	a0,1
     ...
     5b4:	7e050513          	addi	a0,a0,2016 # 5d90 <malloc+0x5da>
     5b8:	00005097          	auipc	ra,0x5
     5bc:	140080e7          	jalr	320(ra) # 56f8 <printf>
      exit(1);
     5c0:	4505                	li	a0,1
     ...
     5ce:	76650513          	addi	a0,a0,1894 # 5d30 <malloc+0x57a>
     5d2:	00005097          	auipc	ra,0x5
     5d6:	126080e7          	jalr	294(ra) # 56f8 <printf>
      exit(1);
     5da:	4505                	li	a0,1
     ...
     5e8:	7dc50513          	addi	a0,a0,2012 # 5dc0 <malloc+0x60a>
     5ec:	00005097          	auipc	ra,0x5
     5f0:	10c080e7          	jalr	268(ra) # 56f8 <printf>
      exit(1);
     5f4:	4505                	li	a0,1
     ...
     606:	7d650513          	addi	a0,a0,2006 # 5dd8 <malloc+0x622>
     60a:	00005097          	auipc	ra,0x5
     60e:	0ee080e7          	jalr	238(ra) # 56f8 <printf>
      exit(1);
     612:	4505                	li	a0,1
...
000000000000061c <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     65c:	5e858593          	addi	a1,a1,1512 # 5c40 <malloc+0x48a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     678:	5bc50513          	addi	a0,a0,1468 # 5c30 <malloc+0x47a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     6a4:	59050513          	addi	a0,a0,1424 # 5c30 <malloc+0x47a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6b8:	57c50513          	addi	a0,a0,1404 # 5c30 <malloc+0x47a>
  ...
  write(fd1, "abcdef", 6);
     ...
     6f6:	77658593          	addi	a1,a1,1910 # 5e68 <malloc+0x6b2>
     6fa:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     738:	4fc50513          	addi	a0,a0,1276 # 5c30 <malloc+0x47a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     77c:	69050513          	addi	a0,a0,1680 # 5e08 <malloc+0x652>
     780:	00005097          	auipc	ra,0x5
     784:	f78080e7          	jalr	-136(ra) # 56f8 <printf>
    exit(1);
     788:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     798:	69450513          	addi	a0,a0,1684 # 5e28 <malloc+0x672>
     79c:	00005097          	auipc	ra,0x5
     7a0:	f5c080e7          	jalr	-164(ra) # 56f8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7a4:	8652                	mv	a2,s4
     7a6:	85d6                	mv	a1,s5
     7a8:	00005517          	auipc	a0,0x5
     7ac:	69050513          	addi	a0,a0,1680 # 5e38 <malloc+0x682>
     7b0:	00005097          	auipc	ra,0x5
     7b4:	f48080e7          	jalr	-184(ra) # 56f8 <printf>
    exit(1);
     7b8:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7c8:	69450513          	addi	a0,a0,1684 # 5e58 <malloc+0x6a2>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	f2c080e7          	jalr	-212(ra) # 56f8 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7d4:	8652                	mv	a2,s4
     7d6:	85d6                	mv	a1,s5
     7d8:	00005517          	auipc	a0,0x5
     7dc:	66050513          	addi	a0,a0,1632 # 5e38 <malloc+0x682>
     7e0:	00005097          	auipc	ra,0x5
     7e4:	f18080e7          	jalr	-232(ra) # 56f8 <printf>
    exit(1);
     7e8:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7fa:	67a50513          	addi	a0,a0,1658 # 5e70 <malloc+0x6ba>
     7fe:	00005097          	auipc	ra,0x5
     802:	efa080e7          	jalr	-262(ra) # 56f8 <printf>
    exit(1);
     806:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     818:	67c50513          	addi	a0,a0,1660 # 5e90 <malloc+0x6da>
     81c:	00005097          	auipc	ra,0x5
     820:	edc080e7          	jalr	-292(ra) # 56f8 <printf>
    exit(1);
     824:	4505                	li	a0,1
...
000000000000082e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     84c:	66850513          	addi	a0,a0,1640 # 5eb0 <malloc+0x6fa>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     864:	67898993          	addi	s3,s3,1656 # 5ed8 <malloc+0x722>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     868:	00005a97          	auipc	s5,0x5
     86c:	6a8a8a93          	addi	s5,s5,1704 # 5f10 <malloc+0x75a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8b2:	60250513          	addi	a0,a0,1538 # 5eb0 <malloc+0x6fa>
  ...
  if(unlink("small") < 0){
     ...
     8ee:	5c650513          	addi	a0,a0,1478 # 5eb0 <malloc+0x6fa>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     918:	5a450513          	addi	a0,a0,1444 # 5eb8 <malloc+0x702>
     91c:	00005097          	auipc	ra,0x5
     920:	ddc080e7          	jalr	-548(ra) # 56f8 <printf>
    exit(1);
     924:	4505                	li	a0,1
     ...
     934:	5b850513          	addi	a0,a0,1464 # 5ee8 <malloc+0x732>
     938:	00005097          	auipc	ra,0x5
     93c:	dc0080e7          	jalr	-576(ra) # 56f8 <printf>
      exit(1);
     940:	4505                	li	a0,1
     ...
     950:	5d450513          	addi	a0,a0,1492 # 5f20 <malloc+0x76a>
     954:	00005097          	auipc	ra,0x5
     958:	da4080e7          	jalr	-604(ra) # 56f8 <printf>
      exit(1);
     95c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     96c:	5e050513          	addi	a0,a0,1504 # 5f48 <malloc+0x792>
     970:	00005097          	auipc	ra,0x5
     974:	d88080e7          	jalr	-632(ra) # 56f8 <printf>
    exit(1);
     978:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     988:	5e450513          	addi	a0,a0,1508 # 5f68 <malloc+0x7b2>
     98c:	00005097          	auipc	ra,0x5
     990:	d6c080e7          	jalr	-660(ra) # 56f8 <printf>
    exit(1);
     994:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9a4:	5e050513          	addi	a0,a0,1504 # 5f80 <malloc+0x7ca>
     9a8:	00005097          	auipc	ra,0x5
     9ac:	d50080e7          	jalr	-688(ra) # 56f8 <printf>
    exit(1);
     9b0:	4505                	li	a0,1
...
00000000000009ba <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9d6:	5ce50513          	addi	a0,a0,1486 # 5fa0 <malloc+0x7ea>
  ...
  fd = open("big", O_RDONLY);
     ...
     a28:	57c50513          	addi	a0,a0,1404 # 5fa0 <malloc+0x7ea>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a70:	53c50513          	addi	a0,a0,1340 # 5fa8 <malloc+0x7f2>
     a74:	00005097          	auipc	ra,0x5
     a78:	c84080e7          	jalr	-892(ra) # 56f8 <printf>
    exit(1);
     a7c:	4505                	li	a0,1
     ...
     a8c:	54050513          	addi	a0,a0,1344 # 5fc8 <malloc+0x812>
     a90:	00005097          	auipc	ra,0x5
     a94:	c68080e7          	jalr	-920(ra) # 56f8 <printf>
      exit(1);
     a98:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     aa8:	54c50513          	addi	a0,a0,1356 # 5ff0 <malloc+0x83a>
     aac:	00005097          	auipc	ra,0x5
     ab0:	c4c080e7          	jalr	-948(ra) # 56f8 <printf>
    exit(1);
     ab4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ad4:	4d050513          	addi	a0,a0,1232 # 5fa0 <malloc+0x7ea>
     ...
     afe:	51650513          	addi	a0,a0,1302 # 6010 <malloc+0x85a>
     b02:	00005097          	auipc	ra,0x5
     b06:	bf6080e7          	jalr	-1034(ra) # 56f8 <printf>
        exit(1);
     b0a:	4505                	li	a0,1
     ...
     b1a:	52250513          	addi	a0,a0,1314 # 6038 <malloc+0x882>
     b1e:	00005097          	auipc	ra,0x5
     b22:	bda080e7          	jalr	-1062(ra) # 56f8 <printf>
      exit(1);
     b26:	4505                	li	a0,1
     ...
     b36:	51e50513          	addi	a0,a0,1310 # 6050 <malloc+0x89a>
     b3a:	00005097          	auipc	ra,0x5
     b3e:	bbe080e7          	jalr	-1090(ra) # 56f8 <printf>
      exit(1);
     b42:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b52:	52a50513          	addi	a0,a0,1322 # 6078 <malloc+0x8c2>
     b56:	00005097          	auipc	ra,0x5
     b5a:	ba2080e7          	jalr	-1118(ra) # 56f8 <printf>
    exit(1);
     b5e:	4505                	li	a0,1
...
0000000000000b68 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b80:	e6c50513          	addi	a0,a0,-404 # 59e8 <malloc+0x232>
  ...
  write(fd, "hello", SZ);
     ...
     b98:	51c58593          	addi	a1,a1,1308 # 60b0 <malloc+0x8fa>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bb4:	e3850513          	addi	a0,a0,-456 # 59e8 <malloc+0x232>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bca:	e2250513          	addi	a0,a0,-478 # 59e8 <malloc+0x232>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     be0:	e0c50513          	addi	a0,a0,-500 # 59e8 <malloc+0x232>
  ...
  write(fd1, "yyy", 3);
     ...
     bf4:	50858593          	addi	a1,a1,1288 # 60f8 <malloc+0x942>
  ...
  unlink("unlinkread");
     ...
     c5c:	d9050513          	addi	a0,a0,-624 # 59e8 <malloc+0x232>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c7c:	41850513          	addi	a0,a0,1048 # 6090 <malloc+0x8da>
     c80:	00005097          	auipc	ra,0x5
     c84:	a78080e7          	jalr	-1416(ra) # 56f8 <printf>
    exit(1);
     c88:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c98:	42450513          	addi	a0,a0,1060 # 60b8 <malloc+0x902>
     c9c:	00005097          	auipc	ra,0x5
     ca0:	a5c080e7          	jalr	-1444(ra) # 56f8 <printf>
    exit(1);
     ca4:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cb4:	42850513          	addi	a0,a0,1064 # 60d8 <malloc+0x922>
     cb8:	00005097          	auipc	ra,0x5
     cbc:	a40080e7          	jalr	-1472(ra) # 56f8 <printf>
    exit(1);
     cc0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cd0:	43450513          	addi	a0,a0,1076 # 6100 <malloc+0x94a>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	a24080e7          	jalr	-1500(ra) # 56f8 <printf>
    exit(1);
     cdc:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     cec:	43850513          	addi	a0,a0,1080 # 6120 <malloc+0x96a>
     cf0:	00005097          	auipc	ra,0x5
     cf4:	a08080e7          	jalr	-1528(ra) # 56f8 <printf>
    exit(1);
     cf8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d08:	43c50513          	addi	a0,a0,1084 # 6140 <malloc+0x98a>
     d0c:	00005097          	auipc	ra,0x5
     d10:	9ec080e7          	jalr	-1556(ra) # 56f8 <printf>
    exit(1);
     d14:	4505                	li	a0,1
...
0000000000000d1e <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6c:	34858593          	addi	a1,a1,840 # 60b0 <malloc+0x8fa>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d8c:	3e058593          	addi	a1,a1,992 # 6168 <malloc+0x9b2>
     d90:	00005517          	auipc	a0,0x5
     d94:	3d050513          	addi	a0,a0,976 # 6160 <malloc+0x9aa>
  ...
  unlink("lf1");
     ...
     da8:	3bc50513          	addi	a0,a0,956 # 6160 <malloc+0x9aa>
     dac:	00004097          	auipc	ra,0x4
     db0:	61c080e7          	jalr	1564(ra) # 53c8 <unlink>
  if(open("lf1", 0) >= 0){
     db4:	4581                	li	a1,0
     db6:	00005517          	auipc	a0,0x5
     dba:	3aa50513          	addi	a0,a0,938 # 6160 <malloc+0x9aa>
  ...
  fd = open("lf2", 0);
     ...
     dd0:	39c50513          	addi	a0,a0,924 # 6168 <malloc+0x9b2>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e08:	36458593          	addi	a1,a1,868 # 6168 <malloc+0x9b2>
     e0c:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e1e:	34e50513          	addi	a0,a0,846 # 6168 <malloc+0x9b2>
     e22:	00004097          	auipc	ra,0x4
     e26:	5a6080e7          	jalr	1446(ra) # 53c8 <unlink>
  if(link("lf2", "lf1") >= 0){
     e2a:	00005597          	auipc	a1,0x5
     e2e:	33658593          	addi	a1,a1,822 # 6160 <malloc+0x9aa>
     e32:	00005517          	auipc	a0,0x5
     e36:	33650513          	addi	a0,a0,822 # 6168 <malloc+0x9b2>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e4a:	31a58593          	addi	a1,a1,794 # 6160 <malloc+0x9aa>
     e4e:	00005517          	auipc	a0,0x5
     e52:	42250513          	addi	a0,a0,1058 # 6270 <malloc+0xaba>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e74:	30050513          	addi	a0,a0,768 # 6170 <malloc+0x9ba>
     e78:	00005097          	auipc	ra,0x5
     e7c:	880080e7          	jalr	-1920(ra) # 56f8 <printf>
    exit(1);
     e80:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e90:	2fc50513          	addi	a0,a0,764 # 6188 <malloc+0x9d2>
     e94:	00005097          	auipc	ra,0x5
     e98:	864080e7          	jalr	-1948(ra) # 56f8 <printf>
    exit(1);
     e9c:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     eac:	2f850513          	addi	a0,a0,760 # 61a0 <malloc+0x9ea>
     eb0:	00005097          	auipc	ra,0x5
     eb4:	848080e7          	jalr	-1976(ra) # 56f8 <printf>
    exit(1);
     eb8:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec8:	2fc50513          	addi	a0,a0,764 # 61c0 <malloc+0xa0a>
     ecc:	00005097          	auipc	ra,0x5
     ed0:	82c080e7          	jalr	-2004(ra) # 56f8 <printf>
    exit(1);
     ed4:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     ee4:	31050513          	addi	a0,a0,784 # 61f0 <malloc+0xa3a>
     ee8:	00005097          	auipc	ra,0x5
     eec:	810080e7          	jalr	-2032(ra) # 56f8 <printf>
    exit(1);
     ef0:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     f00:	30c50513          	addi	a0,a0,780 # 6208 <malloc+0xa52>
     f04:	00004097          	auipc	ra,0x4
     f08:	7f4080e7          	jalr	2036(ra) # 56f8 <printf>
    exit(1);
     f0c:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f1c:	30850513          	addi	a0,a0,776 # 6220 <malloc+0xa6a>
     f20:	00004097          	auipc	ra,0x4
     f24:	7d8080e7          	jalr	2008(ra) # 56f8 <printf>
    exit(1);
     f28:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f38:	31450513          	addi	a0,a0,788 # 6248 <malloc+0xa92>
     f3c:	00004097          	auipc	ra,0x4
     f40:	7bc080e7          	jalr	1980(ra) # 56f8 <printf>
    exit(1);
     f44:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f54:	32850513          	addi	a0,a0,808 # 6278 <malloc+0xac2>
     f58:	00004097          	auipc	ra,0x4
     f5c:	7a0080e7          	jalr	1952(ra) # 56f8 <printf>
    exit(1);
     f60:	4505                	li	a0,1
...
0000000000000f6a <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fba:	2e2a0a13          	addi	s4,s4,738 # 6298 <malloc+0xae2>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    100c:	29050513          	addi	a0,a0,656 # 6298 <malloc+0xae2>
  ...
  for(i = 0; i < N; i++){
    ...
    107c:	22850513          	addi	a0,a0,552 # 62a0 <malloc+0xaea>
    1080:	00004097          	auipc	ra,0x4
    1084:	678080e7          	jalr	1656(ra) # 56f8 <printf>
    exit(1);
    1088:	4505                	li	a0,1
    ...
    109c:	22850513          	addi	a0,a0,552 # 62c0 <malloc+0xb0a>
    10a0:	00004097          	auipc	ra,0x4
    10a4:	658080e7          	jalr	1624(ra) # 56f8 <printf>
      exit(1);
    10a8:	4505                	li	a0,1
    ...
    10b8:	22c50513          	addi	a0,a0,556 # 62e0 <malloc+0xb2a>
    10bc:	00004097          	auipc	ra,0x4
    10c0:	63c080e7          	jalr	1596(ra) # 56f8 <printf>
      exit(1);
    10c4:	4505                	li	a0,1
...
00000000000010ce <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10ea:	21a98993          	addi	s3,s3,538 # 6300 <malloc+0xb4a>
    10ee:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1126:	1ee50513          	addi	a0,a0,494 # 6310 <malloc+0xb5a>
    112a:	00004097          	auipc	ra,0x4
    112e:	5ce080e7          	jalr	1486(ra) # 56f8 <printf>
      exit(1);
    1132:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    1192:	a4a98993          	addi	s3,s3,-1462 # 5bd8 <malloc+0x422>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	1b878793          	addi	a5,a5,440 # 73d0 <malloc+0x1c1a>
  ...
  if(pid == 0){
    ...
    1252:	dda78793          	addi	a5,a5,-550 # 8028 <big.1267>
    ...
    1278:	8d478793          	addi	a5,a5,-1836 # 7b48 <malloc+0x2392>
    ...
    129c:	94050513          	addi	a0,a0,-1728 # 5bd8 <malloc+0x422>
    ...
    12b4:	10850513          	addi	a0,a0,264 # 63b8 <malloc+0xc02>
    12b8:	00004097          	auipc	ra,0x4
    12bc:	440080e7          	jalr	1088(ra) # 56f8 <printf>
      exit(1);
    12c0:	4505                	li	a0,1
    ...
    12d4:	06050513          	addi	a0,a0,96 # 6330 <malloc+0xb7a>
    12d8:	00004097          	auipc	ra,0x4
    12dc:	420080e7          	jalr	1056(ra) # 56f8 <printf>
    exit(1);
    12e0:	4505                	li	a0,1
    ...
    12f4:	06050513          	addi	a0,a0,96 # 6350 <malloc+0xb9a>
    12f8:	00004097          	auipc	ra,0x4
    12fc:	400080e7          	jalr	1024(ra) # 56f8 <printf>
    exit(1);
    1300:	4505                	li	a0,1
    ...
    1316:	05e50513          	addi	a0,a0,94 # 6370 <malloc+0xbba>
    131a:	00004097          	auipc	ra,0x4
    131e:	3de080e7          	jalr	990(ra) # 56f8 <printf>
    exit(1);
    1322:	4505                	li	a0,1
    ...
    1336:	06650513          	addi	a0,a0,102 # 6398 <malloc+0xbe2>
    133a:	00004097          	auipc	ra,0x4
    133e:	3be080e7          	jalr	958(ra) # 56f8 <printf>
    exit(1);
    1342:	4505                	li	a0,1
    ...
    1350:	4b450513          	addi	a0,a0,1204 # 6800 <malloc+0x104a>
    1354:	00004097          	auipc	ra,0x4
    1358:	3a4080e7          	jalr	932(ra) # 56f8 <printf>
    exit(1);
    135c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    139a:	04a50513          	addi	a0,a0,74 # 63e0 <malloc+0xc2a>
    139e:	00004097          	auipc	ra,0x4
    13a2:	35a080e7          	jalr	858(ra) # 56f8 <printf>
    exit(1);
    13a6:	4505                	li	a0,1
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13cc:	86850513          	addi	a0,a0,-1944 # 5c30 <malloc+0x47a>
  ...
  if(pid == 0){
    ...
    13f6:	83ea0a13          	addi	s4,s4,-1986 # 5c30 <malloc+0x47a>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	046a8a93          	addi	s5,s5,70 # 6440 <malloc+0xc8a>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    146e:	fa650513          	addi	a0,a0,-90 # 6410 <malloc+0xc5a>
    1472:	00004097          	auipc	ra,0x4
    1476:	286080e7          	jalr	646(ra) # 56f8 <printf>
    exit(1);
    147a:	4505                	li	a0,1
    ...
    148a:	fa250513          	addi	a0,a0,-94 # 6428 <malloc+0xc72>
    148e:	00004097          	auipc	ra,0x4
    1492:	26a080e7          	jalr	618(ra) # 56f8 <printf>
        exit(1);
    1496:	4505                	li	a0,1
    ...
    14a8:	fac50513          	addi	a0,a0,-84 # 6450 <malloc+0xc9a>
    14ac:	00004097          	auipc	ra,0x4
    14b0:	24c080e7          	jalr	588(ra) # 56f8 <printf>
        exit(1);
    14b4:	4505                	li	a0,1
    ...
    14c6:	76ea0a13          	addi	s4,s4,1902 # 5c30 <malloc+0x47a>
    int n = write(fd, "xxx", 3);
    14ca:	00005a97          	auipc	s5,0x5
    14ce:	fa6a8a93          	addi	s5,s5,-90 # 6470 <malloc+0xcba>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1518:	71c50513          	addi	a0,a0,1820 # 5c30 <malloc+0x47a>
  ...
  exit(xstatus);
    ...
    1536:	ef650513          	addi	a0,a0,-266 # 6428 <malloc+0xc72>
    153a:	00004097          	auipc	ra,0x4
    153e:	1be080e7          	jalr	446(ra) # 56f8 <printf>
      exit(1);
    1542:	4505                	li	a0,1
    ...
    1554:	f2850513          	addi	a0,a0,-216 # 6478 <malloc+0xcc2>
    1558:	00004097          	auipc	ra,0x4
    155c:	1a0080e7          	jalr	416(ra) # 56f8 <printf>
      exit(1);
    1560:	4505                	li	a0,1
...
000000000000156a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    157c:	66078793          	addi	a5,a5,1632 # 5bd8 <malloc+0x422>
    1580:	fcf43023          	sd	a5,-64(s0)
    1584:	00005797          	auipc	a5,0x5
    1588:	f1478793          	addi	a5,a5,-236 # 6498 <malloc+0xce2>
    158c:	fcf43423          	sd	a5,-56(s0)
    1590:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1594:	00005517          	auipc	a0,0x5
    1598:	f0c50513          	addi	a0,a0,-244 # 64a0 <malloc+0xcea>
  ...
  if(pid == 0) {
    ...
    15c6:	ede50513          	addi	a0,a0,-290 # 64a0 <malloc+0xcea>
    ...
    15e2:	ee250513          	addi	a0,a0,-286 # 64c0 <malloc+0xd0a>
    15e6:	00004097          	auipc	ra,0x4
    15ea:	112080e7          	jalr	274(ra) # 56f8 <printf>
      exit(1);
    15ee:	4505                	li	a0,1
    ...
    15fe:	e1650513          	addi	a0,a0,-490 # 6410 <malloc+0xc5a>
    1602:	00004097          	auipc	ra,0x4
    1606:	0f6080e7          	jalr	246(ra) # 56f8 <printf>
     exit(1);
    160a:	4505                	li	a0,1
    ...
    161a:	e9250513          	addi	a0,a0,-366 # 64a8 <malloc+0xcf2>
    161e:	00004097          	auipc	ra,0x4
    1622:	0da080e7          	jalr	218(ra) # 56f8 <printf>
      exit(1);
    1626:	4505                	li	a0,1
    ...
    1638:	5a450513          	addi	a0,a0,1444 # 5bd8 <malloc+0x422>
  ...
  if(xstatus != 0)
    ...
    166c:	e6850513          	addi	a0,a0,-408 # 64d0 <malloc+0xd1a>
    1670:	00004097          	auipc	ra,0x4
    1674:	088080e7          	jalr	136(ra) # 56f8 <printf>
      exit(1);
    1678:	4505                	li	a0,1
    ...
    1688:	e6450513          	addi	a0,a0,-412 # 64e8 <malloc+0xd32>
    168c:	00004097          	auipc	ra,0x4
    1690:	06c080e7          	jalr	108(ra) # 56f8 <printf>
    1694:	b7d1                	j	1658 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    1696:	4581                	li	a1,0
    1698:	00005517          	auipc	a0,0x5
    169c:	e0850513          	addi	a0,a0,-504 # 64a0 <malloc+0xcea>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16c6:	8a650513          	addi	a0,a0,-1882 # 5f68 <malloc+0x7b2>
    16ca:	00004097          	auipc	ra,0x4
    16ce:	02e080e7          	jalr	46(ra) # 56f8 <printf>
    exit(1);
    16d2:	4505                	li	a0,1
    ...
    16e2:	d4a50513          	addi	a0,a0,-694 # 6428 <malloc+0xc72>
    16e6:	00004097          	auipc	ra,0x4
    16ea:	012080e7          	jalr	18(ra) # 56f8 <printf>
    exit(1);
    16ee:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16fc:	da850513          	addi	a0,a0,-600 # 64a0 <malloc+0xcea>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1726:	dde50513          	addi	a0,a0,-546 # 6500 <malloc+0xd4a>
    172a:	00004097          	auipc	ra,0x4
    172e:	fce080e7          	jalr	-50(ra) # 56f8 <printf>
    exit(1);
    1732:	4505                	li	a0,1
...
0000000000001746 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e8:	d3450513          	addi	a0,a0,-716 # 6518 <malloc+0xd62>
    17ec:	00004097          	auipc	ra,0x4
    17f0:	f0c080e7          	jalr	-244(ra) # 56f8 <printf>
    exit(1);
    17f4:	4505                	li	a0,1
    ...
    1822:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    186e:	cc650513          	addi	a0,a0,-826 # 6530 <malloc+0xd7a>
    1872:	00004097          	auipc	ra,0x4
    1876:	e86080e7          	jalr	-378(ra) # 56f8 <printf>
        exit(1);
    187a:	4505                	li	a0,1
    ...
    188a:	cc250513          	addi	a0,a0,-830 # 6548 <malloc+0xd92>
    188e:	00004097          	auipc	ra,0x4
    1892:	e6a080e7          	jalr	-406(ra) # 56f8 <printf>
}
    ...
    18bc:	ca850513          	addi	a0,a0,-856 # 6560 <malloc+0xdaa>
    18c0:	00004097          	auipc	ra,0x4
    18c4:	e38080e7          	jalr	-456(ra) # 56f8 <printf>
      exit(1);
    18c8:	4505                	li	a0,1
    ...
    18fc:	c8850513          	addi	a0,a0,-888 # 6580 <malloc+0xdca>
    1900:	00004097          	auipc	ra,0x4
    1904:	df8080e7          	jalr	-520(ra) # 56f8 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
0000000000001912 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    196e:	aa650513          	addi	a0,a0,-1370 # 6410 <malloc+0xc5a>
    1972:	00004097          	auipc	ra,0x4
    1976:	d86080e7          	jalr	-634(ra) # 56f8 <printf>
      exit(1);
    197a:	4505                	li	a0,1
    ...
    198a:	c1250513          	addi	a0,a0,-1006 # 6598 <malloc+0xde2>
    198e:	00004097          	auipc	ra,0x4
    1992:	d6a080e7          	jalr	-662(ra) # 56f8 <printf>
        exit(1);
    1996:	4505                	li	a0,1
    ...
    19a6:	c0e50513          	addi	a0,a0,-1010 # 65b0 <malloc+0xdfa>
    19aa:	00004097          	auipc	ra,0x4
    19ae:	d4e080e7          	jalr	-690(ra) # 56f8 <printf>
        exit(1);
    19b2:	4505                	li	a0,1
...
00000000000019c6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a1e:	9f650513          	addi	a0,a0,-1546 # 6410 <malloc+0xc5a>
    1a22:	00004097          	auipc	ra,0x4
    1a26:	cd6080e7          	jalr	-810(ra) # 56f8 <printf>
      exit(1);
    1a2a:	4505                	li	a0,1
    ...
    1a42:	9d250513          	addi	a0,a0,-1582 # 6410 <malloc+0xc5a>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	cb2080e7          	jalr	-846(ra) # 56f8 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
...
0000000000001a60 <forkfork>:
{
    ...
    1abc:	b1850513          	addi	a0,a0,-1256 # 65d0 <malloc+0xe1a>
    1ac0:	00004097          	auipc	ra,0x4
    1ac4:	c38080e7          	jalr	-968(ra) # 56f8 <printf>
      exit(1);
    1ac8:	4505                	li	a0,1
    ...
    1ace:	8ae080e7          	jalr	-1874(ra) # 5378 <exit>
{
    ...
    1b14:	ad050513          	addi	a0,a0,-1328 # 65e0 <malloc+0xe2a>
    1b18:	00004097          	auipc	ra,0x4
    1b1c:	be0080e7          	jalr	-1056(ra) # 56f8 <printf>
      exit(1);
    1b20:	4505                	li	a0,1
...
0000000000001b2a <reparent2>:
{
  ...
  exit(0);
    ...
    1b62:	ca250513          	addi	a0,a0,-862 # 6800 <malloc+0x104a>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	b92080e7          	jalr	-1134(ra) # 56f8 <printf>
      exit(1);
    1b6e:	4505                	li	a0,1
...
0000000000001b92 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c00:	c0450513          	addi	a0,a0,-1020 # 6800 <malloc+0x104a>
    1c04:	00004097          	auipc	ra,0x4
    1c08:	af4080e7          	jalr	-1292(ra) # 56f8 <printf>
      exit(1);
    1c0c:	4505                	li	a0,1
    ...
    1c2c:	88050513          	addi	a0,a0,-1920 # 64a8 <malloc+0xcf2>
    1c30:	00004097          	auipc	ra,0x4
    1c34:	ac8080e7          	jalr	-1336(ra) # 56f8 <printf>
          exit(1);
    1c38:	4505                	li	a0,1
    ...
    1c9e:	96650513          	addi	a0,a0,-1690 # 6600 <malloc+0xe4a>
    1ca2:	00004097          	auipc	ra,0x4
    1ca6:	a56080e7          	jalr	-1450(ra) # 56f8 <printf>
            exit(1);
    1caa:	4505                	li	a0,1
    ...
    1cd2:	94a50513          	addi	a0,a0,-1718 # 6618 <malloc+0xe62>
    1cd6:	00004097          	auipc	ra,0x4
    1cda:	a22080e7          	jalr	-1502(ra) # 56f8 <printf>
        exit(1);
    1cde:	4505                	li	a0,1
    ...
    1d38:	90c50513          	addi	a0,a0,-1780 # 6640 <malloc+0xe8a>
    1d3c:	00004097          	auipc	ra,0x4
    1d40:	9bc080e7          	jalr	-1604(ra) # 56f8 <printf>
        exit(1);
    1d44:	4505                	li	a0,1
...
0000000000001db8 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd8:	e7450513          	addi	a0,a0,-396 # 5c48 <malloc+0x492>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e14:	e38a8a93          	addi	s5,s5,-456 # 5c48 <malloc+0x492>
      link("cat", "x");
    1e18:	00005b97          	auipc	s7,0x5
    1e1c:	850b8b93          	addi	s7,s7,-1968 # 6668 <malloc+0xeb2>
    1e20:	a091                	j	1e64 <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e22:	85a6                	mv	a1,s1
    1e24:	00004517          	auipc	a0,0x4
    1e28:	5ec50513          	addi	a0,a0,1516 # 6410 <malloc+0xc5a>
    1e2c:	00004097          	auipc	ra,0x4
    1e30:	8cc080e7          	jalr	-1844(ra) # 56f8 <printf>
    exit(1);
    1e34:	4505                	li	a0,1
...
0000000000001eba <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1eea:	7a250513          	addi	a0,a0,1954 # 6688 <malloc+0xed2>
    1eee:	00004097          	auipc	ra,0x4
    1ef2:	80a080e7          	jalr	-2038(ra) # 56f8 <printf>
    exit(1);
    1ef6:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1f4c:	72850513          	addi	a0,a0,1832 # 6670 <malloc+0xeba>
    1f50:	00003097          	auipc	ra,0x3
    1f54:	7a8080e7          	jalr	1960(ra) # 56f8 <printf>
    exit(1);
    1f58:	4505                	li	a0,1
    ...
    1f68:	74c50513          	addi	a0,a0,1868 # 66b0 <malloc+0xefa>
    1f6c:	00003097          	auipc	ra,0x3
    1f70:	78c080e7          	jalr	1932(ra) # 56f8 <printf>
      exit(1);
    1f74:	4505                	li	a0,1
    ...
    1f84:	74850513          	addi	a0,a0,1864 # 66c8 <malloc+0xf12>
    1f88:	00003097          	auipc	ra,0x3
    1f8c:	770080e7          	jalr	1904(ra) # 56f8 <printf>
    exit(1);
    1f90:	4505                	li	a0,1
...
0000000000001f9a <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2004:	41050513          	addi	a0,a0,1040 # 6410 <malloc+0xc5a>
    2008:	00003097          	auipc	ra,0x3
    200c:	6f0080e7          	jalr	1776(ra) # 56f8 <printf>
      exit(1);
    2010:	4505                	li	a0,1
    ...
    2024:	6c050513          	addi	a0,a0,1728 # 66e0 <malloc+0xf2a>
    2028:	00003097          	auipc	ra,0x3
    202c:	6d0080e7          	jalr	1744(ra) # 56f8 <printf>
      exit(1);
    2030:	4505                	li	a0,1
...
0000000000002044 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2054:	6b050513          	addi	a0,a0,1712 # 6700 <malloc+0xf4a>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2086:	67e50513          	addi	a0,a0,1662 # 6700 <malloc+0xf4a>
  ...
  close(fd);
    ...
    20ac:	e8078793          	addi	a5,a5,-384 # 7f28 <args.1804>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	f7068693          	addi	a3,a3,-144 # 8020 <args.1804+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    20b8:	00004717          	auipc	a4,0x4
    20bc:	65870713          	addi	a4,a4,1624 # 6710 <malloc+0xf5a>
    ...
    2110:	6e450513          	addi	a0,a0,1764 # 67f0 <malloc+0x103a>
    2114:	00003097          	auipc	ra,0x3
    2118:	5e4080e7          	jalr	1508(ra) # 56f8 <printf>
    exit(1);
    211c:	4505                	li	a0,1
    ...
    2134:	6e050513          	addi	a0,a0,1760 # 6810 <malloc+0x105a>
    2138:	00003097          	auipc	ra,0x3
    213c:	5c0080e7          	jalr	1472(ra) # 56f8 <printf>
    exit(1);
    2140:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2190:	6a450513          	addi	a0,a0,1700 # 6830 <malloc+0x107a>
    2194:	00003097          	auipc	ra,0x3
    2198:	564080e7          	jalr	1380(ra) # 56f8 <printf>
    exit(1);
    219c:	4505                	li	a0,1
    ...
    21ac:	26850513          	addi	a0,a0,616 # 6410 <malloc+0xc5a>
    21b0:	00003097          	auipc	ra,0x3
    21b4:	548080e7          	jalr	1352(ra) # 56f8 <printf>
    exit(1);
    21b8:	4505                	li	a0,1
...
00000000000021cc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2246:	18e78793          	addi	a5,a5,398 # 73d0 <malloc+0x1c1a>
  ...
  if(ret != -1){
    ...
    2288:	5d450513          	addi	a0,a0,1492 # 6858 <malloc+0x10a2>
    228c:	00003097          	auipc	ra,0x3
    2290:	46c080e7          	jalr	1132(ra) # 56f8 <printf>
    exit(1);
    2294:	4505                	li	a0,1
    ...
    22a6:	08e50513          	addi	a0,a0,142 # 6330 <malloc+0xb7a>
    22aa:	00003097          	auipc	ra,0x3
    22ae:	44e080e7          	jalr	1102(ra) # 56f8 <printf>
    exit(1);
    22b2:	4505                	li	a0,1
    ...
    22c4:	09050513          	addi	a0,a0,144 # 6350 <malloc+0xb9a>
    22c8:	00003097          	auipc	ra,0x3
    22cc:	430080e7          	jalr	1072(ra) # 56f8 <printf>
    exit(1);
    22d0:	4505                	li	a0,1
    ...
    22e4:	09050513          	addi	a0,a0,144 # 6370 <malloc+0xbba>
    22e8:	00003097          	auipc	ra,0x3
    22ec:	410080e7          	jalr	1040(ra) # 56f8 <printf>
    exit(1);
    22f0:	4505                	li	a0,1
    ...
    2302:	09a50513          	addi	a0,a0,154 # 6398 <malloc+0xbe2>
    2306:	00003097          	auipc	ra,0x3
    230a:	3f2080e7          	jalr	1010(ra) # 56f8 <printf>
    exit(1);
    230e:	4505                	li	a0,1
...
0000000000002318 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2356:	6705                	lui	a4,0x1
      *b = 99;
    2358:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff18b0>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2370:	4f450513          	addi	a0,a0,1268 # 6860 <malloc+0x10aa>
    2374:	00003097          	auipc	ra,0x3
    2378:	384080e7          	jalr	900(ra) # 56f8 <printf>
    exit(1);
    237c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    23c4:	4c050513          	addi	a0,a0,1216 # 6880 <malloc+0x10ca>
    23c8:	00003097          	auipc	ra,0x3
    23cc:	330080e7          	jalr	816(ra) # 56f8 <printf>
    exit(1);
    23d0:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2426:	4be50513          	addi	a0,a0,1214 # 68e0 <malloc+0x112a>
    242a:	00003097          	auipc	ra,0x3
    242e:	2ce080e7          	jalr	718(ra) # 56f8 <printf>
    exit(1);
    2432:	4505                	li	a0,1
    ...
    2446:	45e50513          	addi	a0,a0,1118 # 68a0 <malloc+0x10ea>
    244a:	00003097          	auipc	ra,0x3
    244e:	2ae080e7          	jalr	686(ra) # 56f8 <printf>
      exit(1);
    2452:	4505                	li	a0,1
    ...
    2462:	46250513          	addi	a0,a0,1122 # 68c0 <malloc+0x110a>
    2466:	00003097          	auipc	ra,0x3
    246a:	292080e7          	jalr	658(ra) # 56f8 <printf>
    exit(1);
    246e:	4505                	li	a0,1
...
000000000000249e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2500:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f18af>
  a = sbrk(0);
    2504:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2564:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f18af>
  ...
  if(c != a){
    ...
    25ac:	35850513          	addi	a0,a0,856 # 6900 <malloc+0x114a>
    25b0:	00003097          	auipc	ra,0x3
    25b4:	148080e7          	jalr	328(ra) # 56f8 <printf>
    exit(1);
    25b8:	4505                	li	a0,1
    ...
    25c8:	38450513          	addi	a0,a0,900 # 6948 <malloc+0x1192>
    25cc:	00003097          	auipc	ra,0x3
    25d0:	12c080e7          	jalr	300(ra) # 56f8 <printf>
    exit(1);
    25d4:	4505                	li	a0,1
    ...
    25e6:	38650513          	addi	a0,a0,902 # 6968 <malloc+0x11b2>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	10e080e7          	jalr	270(ra) # 56f8 <printf>
    exit(1);
    25f2:	4505                	li	a0,1
    ...
    2604:	3a850513          	addi	a0,a0,936 # 69a8 <malloc+0x11f2>
    2608:	00003097          	auipc	ra,0x3
    260c:	0f0080e7          	jalr	240(ra) # 56f8 <printf>
    exit(1);
    2610:	4505                	li	a0,1
    ...
    2620:	3bc50513          	addi	a0,a0,956 # 69d8 <malloc+0x1222>
    2624:	00003097          	auipc	ra,0x3
    2628:	0d4080e7          	jalr	212(ra) # 56f8 <printf>
    exit(1);
    262c:	4505                	li	a0,1
    ...
    263e:	3d650513          	addi	a0,a0,982 # 6a10 <malloc+0x125a>
    2642:	00003097          	auipc	ra,0x3
    2646:	0b6080e7          	jalr	182(ra) # 56f8 <printf>
    exit(1);
    264a:	4505                	li	a0,1
...
0000000000002654 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2678:	3c450513          	addi	a0,a0,964 # 6a38 <malloc+0x1282>
    267c:	00003097          	auipc	ra,0x3
    2680:	d3c080e7          	jalr	-708(ra) # 53b8 <open>
    2684:	84aa                	mv	s1,a0
  unlink("sbrk");
    2686:	00004517          	auipc	a0,0x4
    268a:	3b250513          	addi	a0,a0,946 # 6a38 <malloc+0x1282>
  ...
  if(pipe((int *) a) != 0){
    ...
    26de:	36650513          	addi	a0,a0,870 # 6a40 <malloc+0x128a>
    26e2:	00003097          	auipc	ra,0x3
    26e6:	016080e7          	jalr	22(ra) # 56f8 <printf>
    exit(1);
    26ea:	4505                	li	a0,1
    ...
    26fa:	36250513          	addi	a0,a0,866 # 6a58 <malloc+0x12a2>
    26fe:	00003097          	auipc	ra,0x3
    2702:	ffa080e7          	jalr	-6(ra) # 56f8 <printf>
    exit(1);
    2706:	4505                	li	a0,1
    ...
    2716:	e0650513          	addi	a0,a0,-506 # 6518 <malloc+0xd62>
    271a:	00003097          	auipc	ra,0x3
    271e:	fde080e7          	jalr	-34(ra) # 56f8 <printf>
    exit(1);
    2722:	4505                	li	a0,1
...
000000000000272c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2740:	33450513          	addi	a0,a0,820 # 6a70 <malloc+0x12ba>
  ...
  close(fd);
    ...
    2788:	ca450513          	addi	a0,a0,-860 # 6428 <malloc+0xc72>
    278c:	00003097          	auipc	ra,0x3
    2790:	f6c080e7          	jalr	-148(ra) # 56f8 <printf>
    exit(1);
    2794:	4505                	li	a0,1
...
000000000000279e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    27d6:	02e50513          	addi	a0,a0,46 # 6800 <malloc+0x104a>
    27da:	00003097          	auipc	ra,0x3
    27de:	f1e080e7          	jalr	-226(ra) # 56f8 <printf>
    exit(1);
    27e2:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    282c:	fd850513          	addi	a0,a0,-40 # 6800 <malloc+0x104a>
    2830:	00003097          	auipc	ra,0x3
    2834:	ec8080e7          	jalr	-312(ra) # 56f8 <printf>
    exit(1);
    2838:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    288c:	f7850513          	addi	a0,a0,-136 # 6800 <malloc+0x104a>
    2890:	00003097          	auipc	ra,0x3
    2894:	e68080e7          	jalr	-408(ra) # 56f8 <printf>
    exit(1);
    2898:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    28f8:	f0c50513          	addi	a0,a0,-244 # 6800 <malloc+0x104a>
    28fc:	00003097          	auipc	ra,0x3
    2900:	dfc080e7          	jalr	-516(ra) # 56f8 <printf>
      exit(1);
    2904:	4505                	li	a0,1
    ...
    294c:	29050513          	addi	a0,a0,656 # 5bd8 <malloc+0x422>
    2950:	faa43c23          	sd	a0,-72(s0)
    2954:	00003797          	auipc	a5,0x3
    2958:	2f478793          	addi	a5,a5,756 # 5c48 <malloc+0x492>
...
000000000000297a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    298a:	2c250513          	addi	a0,a0,706 # 6c48 <malloc+0x1492>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    299c:	10850513          	addi	a0,a0,264 # 6aa0 <malloc+0x12ea>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    29b2:	14a50513          	addi	a0,a0,330 # 6af8 <malloc+0x1342>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    29d0:	1a450513          	addi	a0,a0,420 # 6b70 <malloc+0x13ba>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    29ec:	1f850513          	addi	a0,a0,504 # 6be0 <malloc+0x142a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    29fe:	23e50513          	addi	a0,a0,574 # 6c38 <malloc+0x1482>
  ...
  unlink("12345678901234");
    ...
    2a7c:	00050513          	mv	a0,a0
    2a80:	00003097          	auipc	ra,0x3
    2a84:	c78080e7          	jalr	-904(ra) # 56f8 <printf>
    exit(1);
    2a88:	4505                	li	a0,1
    ...
    2a98:	02c50513          	addi	a0,a0,44 # 6ac0 <malloc+0x130a>
    2a9c:	00003097          	auipc	ra,0x3
    2aa0:	c5c080e7          	jalr	-932(ra) # 56f8 <printf>
    exit(1);
    2aa4:	4505                	li	a0,1
    ...
    2ab4:	07850513          	addi	a0,a0,120 # 6b28 <malloc+0x1372>
    2ab8:	00003097          	auipc	ra,0x3
    2abc:	c40080e7          	jalr	-960(ra) # 56f8 <printf>
    exit(1);
    2ac0:	4505                	li	a0,1
    ...
    2ad0:	0d450513          	addi	a0,a0,212 # 6ba0 <malloc+0x13ea>
    2ad4:	00003097          	auipc	ra,0x3
    2ad8:	c24080e7          	jalr	-988(ra) # 56f8 <printf>
    exit(1);
    2adc:	4505                	li	a0,1
    ...
    2aec:	11850513          	addi	a0,a0,280 # 6c00 <malloc+0x144a>
    2af0:	00003097          	auipc	ra,0x3
    2af4:	c08080e7          	jalr	-1016(ra) # 56f8 <printf>
    exit(1);
    2af8:	4505                	li	a0,1
    ...
    2b08:	15450513          	addi	a0,a0,340 # 6c58 <malloc+0x14a2>
    2b0c:	00003097          	auipc	ra,0x3
    2b10:	bec080e7          	jalr	-1044(ra) # 56f8 <printf>
    exit(1);
    2b14:	4505                	li	a0,1
...
0000000000002b1e <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2b2e:	16650513          	addi	a0,a0,358 # 6c90 <malloc+0x14da>
  ...
  if(chdir("iputdir") < 0){
    ...
    2b42:	15250513          	addi	a0,a0,338 # 6c90 <malloc+0x14da>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2b56:	17e50513          	addi	a0,a0,382 # 6cd0 <malloc+0x151a>
  ...
  if(chdir("/") < 0){
    ...
    2b6a:	19a50513          	addi	a0,a0,410 # 6d00 <malloc+0x154a>
    ...
    2b8a:	11250513          	addi	a0,a0,274 # 6c98 <malloc+0x14e2>
    2b8e:	00003097          	auipc	ra,0x3
    2b92:	b6a080e7          	jalr	-1174(ra) # 56f8 <printf>
    exit(1);
    2b96:	4505                	li	a0,1
    ...
    2ba6:	10e50513          	addi	a0,a0,270 # 6cb0 <malloc+0x14fa>
    2baa:	00003097          	auipc	ra,0x3
    2bae:	b4e080e7          	jalr	-1202(ra) # 56f8 <printf>
    exit(1);
    2bb2:	4505                	li	a0,1
    ...
    2bc2:	12250513          	addi	a0,a0,290 # 6ce0 <malloc+0x152a>
    2bc6:	00003097          	auipc	ra,0x3
    2bca:	b32080e7          	jalr	-1230(ra) # 56f8 <printf>
    exit(1);
    2bce:	4505                	li	a0,1
    ...
    2bde:	12e50513          	addi	a0,a0,302 # 6d08 <malloc+0x1552>
    2be2:	00003097          	auipc	ra,0x3
    2be6:	b16080e7          	jalr	-1258(ra) # 56f8 <printf>
    exit(1);
    2bea:	4505                	li	a0,1
...
0000000000002bf4 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2c12:	08250513          	addi	a0,a0,130 # 6c90 <malloc+0x14da>
    ...
    2c26:	06e50513          	addi	a0,a0,110 # 6c90 <malloc+0x14da>
    ...
    2c3a:	09a50513          	addi	a0,a0,154 # 6cd0 <malloc+0x151a>
    ...
    2c5a:	7ba50513          	addi	a0,a0,1978 # 6410 <malloc+0xc5a>
    2c5e:	00003097          	auipc	ra,0x3
    2c62:	a9a080e7          	jalr	-1382(ra) # 56f8 <printf>
    exit(1);
    2c66:	4505                	li	a0,1
    ...
    2c76:	02650513          	addi	a0,a0,38 # 6c98 <malloc+0x14e2>
    2c7a:	00003097          	auipc	ra,0x3
    2c7e:	a7e080e7          	jalr	-1410(ra) # 56f8 <printf>
      exit(1);
    2c82:	4505                	li	a0,1
    ...
    2c92:	09250513          	addi	a0,a0,146 # 6d20 <malloc+0x156a>
    2c96:	00003097          	auipc	ra,0x3
    2c9a:	a62080e7          	jalr	-1438(ra) # 56f8 <printf>
      exit(1);
    2c9e:	4505                	li	a0,1
    ...
    2cae:	03650513          	addi	a0,a0,54 # 6ce0 <malloc+0x152a>
    2cb2:	00003097          	auipc	ra,0x3
    2cb6:	a46080e7          	jalr	-1466(ra) # 56f8 <printf>
      exit(1);
    2cba:	4505                	li	a0,1
...
0000000000002cdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2cee:	17e50513          	addi	a0,a0,382 # 6e68 <malloc+0x16b2>
    2cf2:	00002097          	auipc	ra,0x2
    2cf6:	6d6080e7          	jalr	1750(ra) # 53c8 <unlink>
  if(mkdir("dd") != 0){
    2cfa:	00004517          	auipc	a0,0x4
    2cfe:	03e50513          	addi	a0,a0,62 # 6d38 <malloc+0x1582>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2d16:	04650513          	addi	a0,a0,70 # 6d58 <malloc+0x15a2>
  ...
  write(fd, "ff", 2);
    ...
    2d2e:	13e58593          	addi	a1,a1,318 # 6e68 <malloc+0x16b2>
  ...
  if(unlink("dd") >= 0){
    ...
    2d48:	ff450513          	addi	a0,a0,-12 # 6d38 <malloc+0x1582>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2d5c:	05850513          	addi	a0,a0,88 # 6db0 <malloc+0x15fa>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2d74:	06850513          	addi	a0,a0,104 # 6dd8 <malloc+0x1622>
  ...
  write(fd, "FF", 2);
    ...
    2d8c:	08058593          	addi	a1,a1,128 # 6e08 <malloc+0x1652>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2da8:	06c50513          	addi	a0,a0,108 # 6e10 <malloc+0x165a>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2dc0:	98458593          	addi	a1,a1,-1660 # b740 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2dd6:	96e74703          	lbu	a4,-1682(a4) # b740 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2df0:	07458593          	addi	a1,a1,116 # 6e60 <malloc+0x16aa>
    2df4:	00004517          	auipc	a0,0x4
    2df8:	fe450513          	addi	a0,a0,-28 # 6dd8 <malloc+0x1622>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2e0c:	fd050513          	addi	a0,a0,-48 # 6dd8 <malloc+0x1622>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2e22:	fba50513          	addi	a0,a0,-70 # 6dd8 <malloc+0x1622>
  ...
  if(chdir("dd") != 0){
    ...
    2e36:	f0650513          	addi	a0,a0,-250 # 6d38 <malloc+0x1582>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2e4a:	0b250513          	addi	a0,a0,178 # 6ef8 <malloc+0x1742>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2e5e:	0ce50513          	addi	a0,a0,206 # 6f28 <malloc+0x1772>
  ...
  if(chdir("./..") != 0){
    ...
    2e72:	0ea50513          	addi	a0,a0,234 # 6f58 <malloc+0x17a2>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2e88:	fdc50513          	addi	a0,a0,-36 # 6e60 <malloc+0x16aa>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2ea0:	8a458593          	addi	a1,a1,-1884 # b740 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2ec2:	f1a50513          	addi	a0,a0,-230 # 6dd8 <malloc+0x1622>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2eda:	11250513          	addi	a0,a0,274 # 6fe8 <malloc+0x1832>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2ef2:	12a50513          	addi	a0,a0,298 # 7018 <malloc+0x1862>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    2f0a:	e3250513          	addi	a0,a0,-462 # 6d38 <malloc+0x1582>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    2f20:	e1c50513          	addi	a0,a0,-484 # 6d38 <malloc+0x1582>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    2f36:	e0650513          	addi	a0,a0,-506 # 6d38 <malloc+0x1582>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2f4a:	16258593          	addi	a1,a1,354 # 70a8 <malloc+0x18f2>
    2f4e:	00004517          	auipc	a0,0x4
    2f52:	09a50513          	addi	a0,a0,154 # 6fe8 <malloc+0x1832>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2f66:	14658593          	addi	a1,a1,326 # 70a8 <malloc+0x18f2>
    2f6a:	00004517          	auipc	a0,0x4
    2f6e:	0ae50513          	addi	a0,a0,174 # 7018 <malloc+0x1862>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2f82:	ee258593          	addi	a1,a1,-286 # 6e60 <malloc+0x16aa>
    2f86:	00004517          	auipc	a0,0x4
    2f8a:	dd250513          	addi	a0,a0,-558 # 6d58 <malloc+0x15a2>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2f9e:	04e50513          	addi	a0,a0,78 # 6fe8 <malloc+0x1832>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2fb2:	06a50513          	addi	a0,a0,106 # 7018 <malloc+0x1862>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2fc6:	e9e50513          	addi	a0,a0,-354 # 6e60 <malloc+0x16aa>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2fda:	04250513          	addi	a0,a0,66 # 7018 <malloc+0x1862>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2fee:	ffe50513          	addi	a0,a0,-2 # 6fe8 <malloc+0x1832>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3002:	d5a50513          	addi	a0,a0,-678 # 6d58 <malloc+0x15a2>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3016:	1e650513          	addi	a0,a0,486 # 71f8 <malloc+0x1a42>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    302a:	e3a50513          	addi	a0,a0,-454 # 6e60 <malloc+0x16aa>
  ...
  if(unlink("dd/ff") != 0){
    ...
    303e:	d1e50513          	addi	a0,a0,-738 # 6d58 <malloc+0x15a2>
  ...
  if(unlink("dd") == 0){
    ...
    3052:	cea50513          	addi	a0,a0,-790 # 6d38 <malloc+0x1582>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3066:	20650513          	addi	a0,a0,518 # 7268 <malloc+0x1ab2>
  ...
  if(unlink("dd") < 0){
    ...
    307a:	cc250513          	addi	a0,a0,-830 # 6d38 <malloc+0x1582>
    ...
    309c:	ca850513          	addi	a0,a0,-856 # 6d40 <malloc+0x158a>
    30a0:	00002097          	auipc	ra,0x2
    30a4:	658080e7          	jalr	1624(ra) # 56f8 <printf>
    exit(1);
    30a8:	4505                	li	a0,1
    ...
    30b8:	cac50513          	addi	a0,a0,-852 # 6d60 <malloc+0x15aa>
    30bc:	00002097          	auipc	ra,0x2
    30c0:	63c080e7          	jalr	1596(ra) # 56f8 <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d4:	cb050513          	addi	a0,a0,-848 # 6d80 <malloc+0x15ca>
    30d8:	00002097          	auipc	ra,0x2
    30dc:	620080e7          	jalr	1568(ra) # 56f8 <printf>
    exit(1);
    30e0:	4505                	li	a0,1
    ...
    30f0:	ccc50513          	addi	a0,a0,-820 # 6db8 <malloc+0x1602>
    30f4:	00002097          	auipc	ra,0x2
    30f8:	604080e7          	jalr	1540(ra) # 56f8 <printf>
    exit(1);
    30fc:	4505                	li	a0,1
    ...
    310c:	ce050513          	addi	a0,a0,-800 # 6de8 <malloc+0x1632>
    3110:	00002097          	auipc	ra,0x2
    3114:	5e8080e7          	jalr	1512(ra) # 56f8 <printf>
    exit(1);
    3118:	4505                	li	a0,1
    ...
    3128:	cfc50513          	addi	a0,a0,-772 # 6e20 <malloc+0x166a>
    312c:	00002097          	auipc	ra,0x2
    3130:	5cc080e7          	jalr	1484(ra) # 56f8 <printf>
    exit(1);
    3134:	4505                	li	a0,1
    ...
    3144:	d0050513          	addi	a0,a0,-768 # 6e40 <malloc+0x168a>
    3148:	00002097          	auipc	ra,0x2
    314c:	5b0080e7          	jalr	1456(ra) # 56f8 <printf>
    exit(1);
    3150:	4505                	li	a0,1
    ...
    3160:	d1450513          	addi	a0,a0,-748 # 6e70 <malloc+0x16ba>
    3164:	00002097          	auipc	ra,0x2
    3168:	594080e7          	jalr	1428(ra) # 56f8 <printf>
    exit(1);
    316c:	4505                	li	a0,1
    ...
    317c:	d2050513          	addi	a0,a0,-736 # 6e98 <malloc+0x16e2>
    3180:	00002097          	auipc	ra,0x2
    3184:	578080e7          	jalr	1400(ra) # 56f8 <printf>
    exit(1);
    3188:	4505                	li	a0,1
    ...
    3198:	d2450513          	addi	a0,a0,-732 # 6eb8 <malloc+0x1702>
    319c:	00002097          	auipc	ra,0x2
    31a0:	55c080e7          	jalr	1372(ra) # 56f8 <printf>
    exit(1);
    31a4:	4505                	li	a0,1
    ...
    31b4:	d3050513          	addi	a0,a0,-720 # 6ee0 <malloc+0x172a>
    31b8:	00002097          	auipc	ra,0x2
    31bc:	540080e7          	jalr	1344(ra) # 56f8 <printf>
    exit(1);
    31c0:	4505                	li	a0,1
    ...
    31d0:	d3c50513          	addi	a0,a0,-708 # 6f08 <malloc+0x1752>
    31d4:	00002097          	auipc	ra,0x2
    31d8:	524080e7          	jalr	1316(ra) # 56f8 <printf>
    exit(1);
    31dc:	4505                	li	a0,1
    ...
    31ec:	d5050513          	addi	a0,a0,-688 # 6f38 <malloc+0x1782>
    31f0:	00002097          	auipc	ra,0x2
    31f4:	508080e7          	jalr	1288(ra) # 56f8 <printf>
    exit(1);
    31f8:	4505                	li	a0,1
    ...
    3208:	d5c50513          	addi	a0,a0,-676 # 6f60 <malloc+0x17aa>
    320c:	00002097          	auipc	ra,0x2
    3210:	4ec080e7          	jalr	1260(ra) # 56f8 <printf>
    exit(1);
    3214:	4505                	li	a0,1
    ...
    3224:	d5850513          	addi	a0,a0,-680 # 6f78 <malloc+0x17c2>
    3228:	00002097          	auipc	ra,0x2
    322c:	4d0080e7          	jalr	1232(ra) # 56f8 <printf>
    exit(1);
    3230:	4505                	li	a0,1
    ...
    3240:	d5c50513          	addi	a0,a0,-676 # 6f98 <malloc+0x17e2>
    3244:	00002097          	auipc	ra,0x2
    3248:	4b4080e7          	jalr	1204(ra) # 56f8 <printf>
    exit(1);
    324c:	4505                	li	a0,1
    ...
    325c:	d6050513          	addi	a0,a0,-672 # 6fb8 <malloc+0x1802>
    3260:	00002097          	auipc	ra,0x2
    3264:	498080e7          	jalr	1176(ra) # 56f8 <printf>
    exit(1);
    3268:	4505                	li	a0,1
    ...
    3278:	d8450513          	addi	a0,a0,-636 # 6ff8 <malloc+0x1842>
    327c:	00002097          	auipc	ra,0x2
    3280:	47c080e7          	jalr	1148(ra) # 56f8 <printf>
    exit(1);
    3284:	4505                	li	a0,1
    ...
    3294:	d9850513          	addi	a0,a0,-616 # 7028 <malloc+0x1872>
    3298:	00002097          	auipc	ra,0x2
    329c:	460080e7          	jalr	1120(ra) # 56f8 <printf>
    exit(1);
    32a0:	4505                	li	a0,1
    ...
    32b0:	d9c50513          	addi	a0,a0,-612 # 7048 <malloc+0x1892>
    32b4:	00002097          	auipc	ra,0x2
    32b8:	444080e7          	jalr	1092(ra) # 56f8 <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32cc:	da050513          	addi	a0,a0,-608 # 7068 <malloc+0x18b2>
    32d0:	00002097          	auipc	ra,0x2
    32d4:	428080e7          	jalr	1064(ra) # 56f8 <printf>
    exit(1);
    32d8:	4505                	li	a0,1
    ...
    32e8:	da450513          	addi	a0,a0,-604 # 7088 <malloc+0x18d2>
    32ec:	00002097          	auipc	ra,0x2
    32f0:	40c080e7          	jalr	1036(ra) # 56f8 <printf>
    exit(1);
    32f4:	4505                	li	a0,1
    ...
    3304:	db850513          	addi	a0,a0,-584 # 70b8 <malloc+0x1902>
    3308:	00002097          	auipc	ra,0x2
    330c:	3f0080e7          	jalr	1008(ra) # 56f8 <printf>
    exit(1);
    3310:	4505                	li	a0,1
    ...
    3320:	dc450513          	addi	a0,a0,-572 # 70e0 <malloc+0x192a>
    3324:	00002097          	auipc	ra,0x2
    3328:	3d4080e7          	jalr	980(ra) # 56f8 <printf>
    exit(1);
    332c:	4505                	li	a0,1
    ...
    333c:	dd050513          	addi	a0,a0,-560 # 7108 <malloc+0x1952>
    3340:	00002097          	auipc	ra,0x2
    3344:	3b8080e7          	jalr	952(ra) # 56f8 <printf>
    exit(1);
    3348:	4505                	li	a0,1
    ...
    3358:	ddc50513          	addi	a0,a0,-548 # 7130 <malloc+0x197a>
    335c:	00002097          	auipc	ra,0x2
    3360:	39c080e7          	jalr	924(ra) # 56f8 <printf>
    exit(1);
    3364:	4505                	li	a0,1
    ...
    3374:	de050513          	addi	a0,a0,-544 # 7150 <malloc+0x199a>
    3378:	00002097          	auipc	ra,0x2
    337c:	380080e7          	jalr	896(ra) # 56f8 <printf>
    exit(1);
    3380:	4505                	li	a0,1
    ...
    3390:	de450513          	addi	a0,a0,-540 # 7170 <malloc+0x19ba>
    3394:	00002097          	auipc	ra,0x2
    3398:	364080e7          	jalr	868(ra) # 56f8 <printf>
    exit(1);
    339c:	4505                	li	a0,1
    ...
    33ac:	df050513          	addi	a0,a0,-528 # 7198 <malloc+0x19e2>
    33b0:	00002097          	auipc	ra,0x2
    33b4:	348080e7          	jalr	840(ra) # 56f8 <printf>
    exit(1);
    33b8:	4505                	li	a0,1
    ...
    33c8:	df450513          	addi	a0,a0,-524 # 71b8 <malloc+0x1a02>
    33cc:	00002097          	auipc	ra,0x2
    33d0:	32c080e7          	jalr	812(ra) # 56f8 <printf>
    exit(1);
    33d4:	4505                	li	a0,1
    ...
    33e4:	df850513          	addi	a0,a0,-520 # 71d8 <malloc+0x1a22>
    33e8:	00002097          	auipc	ra,0x2
    33ec:	310080e7          	jalr	784(ra) # 56f8 <printf>
    exit(1);
    33f0:	4505                	li	a0,1
    ...
    3400:	e0450513          	addi	a0,a0,-508 # 7200 <malloc+0x1a4a>
    3404:	00002097          	auipc	ra,0x2
    3408:	2f4080e7          	jalr	756(ra) # 56f8 <printf>
    exit(1);
    340c:	4505                	li	a0,1
    ...
    341c:	a8050513          	addi	a0,a0,-1408 # 6e98 <malloc+0x16e2>
    3420:	00002097          	auipc	ra,0x2
    3424:	2d8080e7          	jalr	728(ra) # 56f8 <printf>
    exit(1);
    3428:	4505                	li	a0,1
    ...
    3438:	dec50513          	addi	a0,a0,-532 # 7220 <malloc+0x1a6a>
    343c:	00002097          	auipc	ra,0x2
    3440:	2bc080e7          	jalr	700(ra) # 56f8 <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3454:	df050513          	addi	a0,a0,-528 # 7240 <malloc+0x1a8a>
    3458:	00002097          	auipc	ra,0x2
    345c:	2a0080e7          	jalr	672(ra) # 56f8 <printf>
    exit(1);
    3460:	4505                	li	a0,1
    ...
    3470:	e0450513          	addi	a0,a0,-508 # 7270 <malloc+0x1aba>
    3474:	00002097          	auipc	ra,0x2
    3478:	284080e7          	jalr	644(ra) # 56f8 <printf>
    exit(1);
    347c:	4505                	li	a0,1
    ...
    348c:	e0850513          	addi	a0,a0,-504 # 7290 <malloc+0x1ada>
    3490:	00002097          	auipc	ra,0x2
    3494:	268080e7          	jalr	616(ra) # 56f8 <printf>
    exit(1);
    3498:	4505                	li	a0,1
...
00000000000034a2 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    34b2:	dfa50513          	addi	a0,a0,-518 # 72a8 <malloc+0x1af2>
  ...
  if(chdir("dots") != 0){
    ...
    34c4:	de850513          	addi	a0,a0,-536 # 72a8 <malloc+0x1af2>
  ...
  if(unlink(".") == 0){
    ...
    34d6:	d9e50513          	addi	a0,a0,-610 # 6270 <malloc+0xaba>
  ...
  if(unlink("..") == 0){
    ...
    34e8:	e1450513          	addi	a0,a0,-492 # 72f8 <malloc+0x1b42>
  ...
  if(chdir("/") != 0){
    ...
    34fa:	80a50513          	addi	a0,a0,-2038 # 6d00 <malloc+0x154a>
  ...
  if(unlink("dots/.") == 0){
    ...
    350c:	e1050513          	addi	a0,a0,-496 # 7318 <malloc+0x1b62>
  ...
  if(unlink("dots/..") == 0){
    ...
    351e:	e2650513          	addi	a0,a0,-474 # 7340 <malloc+0x1b8a>
  ...
  if(unlink("dots") != 0){
    ...
    3530:	d7c50513          	addi	a0,a0,-644 # 72a8 <malloc+0x1af2>
    ...
    354e:	d6650513          	addi	a0,a0,-666 # 72b0 <malloc+0x1afa>
    3552:	00002097          	auipc	ra,0x2
    3556:	1a6080e7          	jalr	422(ra) # 56f8 <printf>
    exit(1);
    355a:	4505                	li	a0,1
    ...
    356a:	d6250513          	addi	a0,a0,-670 # 72c8 <malloc+0x1b12>
    356e:	00002097          	auipc	ra,0x2
    3572:	18a080e7          	jalr	394(ra) # 56f8 <printf>
    exit(1);
    3576:	4505                	li	a0,1
    ...
    3586:	d5e50513          	addi	a0,a0,-674 # 72e0 <malloc+0x1b2a>
    358a:	00002097          	auipc	ra,0x2
    358e:	16e080e7          	jalr	366(ra) # 56f8 <printf>
    exit(1);
    3592:	4505                	li	a0,1
    ...
    35a2:	d6250513          	addi	a0,a0,-670 # 7300 <malloc+0x1b4a>
    35a6:	00002097          	auipc	ra,0x2
    35aa:	152080e7          	jalr	338(ra) # 56f8 <printf>
    exit(1);
    35ae:	4505                	li	a0,1
    ...
    35be:	74e50513          	addi	a0,a0,1870 # 6d08 <malloc+0x1552>
    35c2:	00002097          	auipc	ra,0x2
    35c6:	136080e7          	jalr	310(ra) # 56f8 <printf>
    exit(1);
    35ca:	4505                	li	a0,1
    ...
    35da:	d4a50513          	addi	a0,a0,-694 # 7320 <malloc+0x1b6a>
    35de:	00002097          	auipc	ra,0x2
    35e2:	11a080e7          	jalr	282(ra) # 56f8 <printf>
    exit(1);
    35e6:	4505                	li	a0,1
    ...
    35f6:	d5650513          	addi	a0,a0,-682 # 7348 <malloc+0x1b92>
    35fa:	00002097          	auipc	ra,0x2
    35fe:	0fe080e7          	jalr	254(ra) # 56f8 <printf>
    exit(1);
    3602:	4505                	li	a0,1
    ...
    3612:	d5a50513          	addi	a0,a0,-678 # 7368 <malloc+0x1bb2>
    3616:	00002097          	auipc	ra,0x2
    361a:	0e2080e7          	jalr	226(ra) # 56f8 <printf>
    exit(1);
    361e:	4505                	li	a0,1
...
0000000000003628 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    363e:	53e50513          	addi	a0,a0,1342 # 5b78 <malloc+0x3c2>
  ...
  if(chdir("dirfile") == 0){
    ...
    365a:	52250513          	addi	a0,a0,1314 # 5b78 <malloc+0x3c2>
  ...
  fd = open("dirfile/xx", 0);
    ...
    366e:	d5e50513          	addi	a0,a0,-674 # 73c8 <malloc+0x1c12>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3686:	d4650513          	addi	a0,a0,-698 # 73c8 <malloc+0x1c12>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    369a:	d3250513          	addi	a0,a0,-718 # 73c8 <malloc+0x1c12>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    36ae:	d1e50513          	addi	a0,a0,-738 # 73c8 <malloc+0x1c12>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    36c2:	d0a58593          	addi	a1,a1,-758 # 73c8 <malloc+0x1c12>
    36c6:	00002517          	auipc	a0,0x2
    36ca:	6aa50513          	addi	a0,a0,1706 # 5d70 <malloc+0x5ba>
  ...
  if(unlink("dirfile") != 0){
    ...
    36de:	49e50513          	addi	a0,a0,1182 # 5b78 <malloc+0x3c2>
  ...
  fd = open(".", O_RDWR);
    ...
    36f4:	b8050513          	addi	a0,a0,-1152 # 6270 <malloc+0xaba>
  ...
  fd = open(".", 0);
    ...
    370a:	b6a50513          	addi	a0,a0,-1174 # 6270 <malloc+0xaba>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    371e:	52e58593          	addi	a1,a1,1326 # 5c48 <malloc+0x492>
  ...
  close(fd);
    ...
    374a:	c4250513          	addi	a0,a0,-958 # 7388 <malloc+0x1bd2>
    374e:	00002097          	auipc	ra,0x2
    3752:	faa080e7          	jalr	-86(ra) # 56f8 <printf>
    exit(1);
    3756:	4505                	li	a0,1
    ...
    3766:	c4650513          	addi	a0,a0,-954 # 73a8 <malloc+0x1bf2>
    376a:	00002097          	auipc	ra,0x2
    376e:	f8e080e7          	jalr	-114(ra) # 56f8 <printf>
    exit(1);
    3772:	4505                	li	a0,1
    ...
    3782:	c5a50513          	addi	a0,a0,-934 # 73d8 <malloc+0x1c22>
    3786:	00002097          	auipc	ra,0x2
    378a:	f72080e7          	jalr	-142(ra) # 56f8 <printf>
    exit(1);
    378e:	4505                	li	a0,1
    ...
    379e:	c3e50513          	addi	a0,a0,-962 # 73d8 <malloc+0x1c22>
    37a2:	00002097          	auipc	ra,0x2
    37a6:	f56080e7          	jalr	-170(ra) # 56f8 <printf>
    exit(1);
    37aa:	4505                	li	a0,1
    ...
    37ba:	c4a50513          	addi	a0,a0,-950 # 7400 <malloc+0x1c4a>
    37be:	00002097          	auipc	ra,0x2
    37c2:	f3a080e7          	jalr	-198(ra) # 56f8 <printf>
    exit(1);
    37c6:	4505                	li	a0,1
    ...
    37d6:	c5650513          	addi	a0,a0,-938 # 7428 <malloc+0x1c72>
    37da:	00002097          	auipc	ra,0x2
    37de:	f1e080e7          	jalr	-226(ra) # 56f8 <printf>
    exit(1);
    37e2:	4505                	li	a0,1
    ...
    37f2:	c6250513          	addi	a0,a0,-926 # 7450 <malloc+0x1c9a>
    37f6:	00002097          	auipc	ra,0x2
    37fa:	f02080e7          	jalr	-254(ra) # 56f8 <printf>
    exit(1);
    37fe:	4505                	li	a0,1
    ...
    380e:	c6e50513          	addi	a0,a0,-914 # 7478 <malloc+0x1cc2>
    3812:	00002097          	auipc	ra,0x2
    3816:	ee6080e7          	jalr	-282(ra) # 56f8 <printf>
    exit(1);
    381a:	4505                	li	a0,1
    ...
    382a:	c7250513          	addi	a0,a0,-910 # 7498 <malloc+0x1ce2>
    382e:	00002097          	auipc	ra,0x2
    3832:	eca080e7          	jalr	-310(ra) # 56f8 <printf>
    exit(1);
    3836:	4505                	li	a0,1
    ...
    3846:	c7e50513          	addi	a0,a0,-898 # 74c0 <malloc+0x1d0a>
    384a:	00002097          	auipc	ra,0x2
    384e:	eae080e7          	jalr	-338(ra) # 56f8 <printf>
    exit(1);
    3852:	4505                	li	a0,1
...
000000000000385c <iref>:
{
    ...
    387a:	c62a0a13          	addi	s4,s4,-926 # 74d8 <malloc+0x1d22>
    mkdir("");
    387e:	00003497          	auipc	s1,0x3
    3882:	76248493          	addi	s1,s1,1890 # 6fe0 <malloc+0x182a>
    link("README", "");
    3886:	00002a97          	auipc	s5,0x2
    388a:	4eaa8a93          	addi	s5,s5,1258 # 5d70 <malloc+0x5ba>
    fd = open("xx", O_CREATE);
    388e:	00004997          	auipc	s3,0x4
    3892:	b4298993          	addi	s3,s3,-1214 # 73d0 <malloc+0x1c1a>
    3896:	a891                	j	38ea <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3898:	85da                	mv	a1,s6
    389a:	00004517          	auipc	a0,0x4
    389e:	c4650513          	addi	a0,a0,-954 # 74e0 <malloc+0x1d2a>
    38a2:	00002097          	auipc	ra,0x2
    38a6:	e56080e7          	jalr	-426(ra) # 56f8 <printf>
      exit(1);
    38aa:	4505                	li	a0,1
    ...
    38ba:	c4250513          	addi	a0,a0,-958 # 74f8 <malloc+0x1d42>
    38be:	00002097          	auipc	ra,0x2
    38c2:	e3a080e7          	jalr	-454(ra) # 56f8 <printf>
      exit(1);
    38c6:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    394e:	9ae98993          	addi	s3,s3,-1618 # 72f8 <malloc+0x1b42>
    unlink("irefd");
    3952:	00004917          	auipc	s2,0x4
    3956:	b8690913          	addi	s2,s2,-1146 # 74d8 <malloc+0x1d22>
    chdir("..");
    395a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3976:	38e50513          	addi	a0,a0,910 # 6d00 <malloc+0x154a>
...
0000000000003996 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    39a6:	b6e50513          	addi	a0,a0,-1170 # 7510 <malloc+0x1d5a>
  ...
  if(pid == 0){
    ...
    39ca:	b4a50513          	addi	a0,a0,-1206 # 7510 <malloc+0x1d5a>
    ...
    39e0:	b5450513          	addi	a0,a0,-1196 # 7530 <malloc+0x1d7a>
    39e4:	00002097          	auipc	ra,0x2
    39e8:	d14080e7          	jalr	-748(ra) # 56f8 <printf>
      exit(1);
    39ec:	4505                	li	a0,1
    ...
    39fc:	b2050513          	addi	a0,a0,-1248 # 7518 <malloc+0x1d62>
    3a00:	00002097          	auipc	ra,0x2
    3a04:	cf8080e7          	jalr	-776(ra) # 56f8 <printf>
    exit(1);
    3a08:	4505                	li	a0,1
    ...
    3a18:	9fc50513          	addi	a0,a0,-1540 # 6410 <malloc+0xc5a>
    3a1c:	00002097          	auipc	ra,0x2
    3a20:	cdc080e7          	jalr	-804(ra) # 56f8 <printf>
    exit(1);
    3a24:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3a46:	ace50513          	addi	a0,a0,-1330 # 7510 <malloc+0x1d5a>
    ...
    3a5a:	baa50513          	addi	a0,a0,-1110 # 6600 <malloc+0xe4a>
    3a5e:	00002097          	auipc	ra,0x2
    3a62:	c9a080e7          	jalr	-870(ra) # 56f8 <printf>
    exit(1);
    3a66:	4505                	li	a0,1
...
0000000000003a88 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3a98:	ac450513          	addi	a0,a0,-1340 # 7558 <malloc+0x1da2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ac4:	a9850513          	addi	a0,a0,-1384 # 7558 <malloc+0x1da2>
  ...
  sleep(10); // one second
    ...
    3afc:	ad850513          	addi	a0,a0,-1320 # 65d0 <malloc+0xe1a>
    3b00:	00002097          	auipc	ra,0x2
    3b04:	bf8080e7          	jalr	-1032(ra) # 56f8 <printf>
    exit(1);
    3b08:	4505                	li	a0,1
    ...
    3b16:	a4648493          	addi	s1,s1,-1466 # 7558 <malloc+0x1da2>
    3b1a:	4581                	li	a1,0
    3b1c:	8526                	mv	a0,s1
...
0000000000003b58 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3b80:	a5450513          	addi	a0,a0,-1452 # 65d0 <malloc+0xe1a>
    3b84:	00002097          	auipc	ra,0x2
    3b88:	b74080e7          	jalr	-1164(ra) # 56f8 <printf>
    exit(1);
    3b8c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3bae:	86650513          	addi	a0,a0,-1946 # 6410 <malloc+0xc5a>
    3bb2:	00002097          	auipc	ra,0x2
    3bb6:	b46080e7          	jalr	-1210(ra) # 56f8 <printf>
    exit(1);
    3bba:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3bf2:	05a58593          	addi	a1,a1,90 # 5c48 <malloc+0x492>
    ...
    3c1c:	7f850513          	addi	a0,a0,2040 # 6410 <malloc+0xc5a>
    3c20:	00002097          	auipc	ra,0x2
    3c24:	ad8080e7          	jalr	-1320(ra) # 56f8 <printf>
     exit(1);
    3c28:	4505                	li	a0,1
    ...
    3c36:	93650513          	addi	a0,a0,-1738 # 7568 <malloc+0x1db2>
    3c3a:	00002097          	auipc	ra,0x2
    3c3e:	abe080e7          	jalr	-1346(ra) # 56f8 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3c56:	aee58593          	addi	a1,a1,-1298 # b740 <buf>
    ...
    3c70:	91450513          	addi	a0,a0,-1772 # 7580 <malloc+0x1dca>
    3c74:	00002097          	auipc	ra,0x2
    3c78:	a84080e7          	jalr	-1404(ra) # 56f8 <printf>
}
  ...
  printf("kill... ");
    ...
    3c9c:	90050513          	addi	a0,a0,-1792 # 7598 <malloc+0x1de2>
    3ca0:	00002097          	auipc	ra,0x2
    3ca4:	a58080e7          	jalr	-1448(ra) # 56f8 <printf>
  kill(pid1);
    3ca8:	854e                	mv	a0,s3
  ...
  printf("wait... ");
    ...
    3cca:	8e250513          	addi	a0,a0,-1822 # 75a8 <malloc+0x1df2>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	a2a080e7          	jalr	-1494(ra) # 56f8 <printf>
  wait(0);
    3cd6:	4501                	li	a0,0
...
0000000000003cf6 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3d2c:	7f050513          	addi	a0,a0,2032 # 6518 <malloc+0xd62>
    3d30:	00002097          	auipc	ra,0x2
    3d34:	9c8080e7          	jalr	-1592(ra) # 56f8 <printf>
    exit(1);
    3d38:	4505                	li	a0,1
    ...
    3d62:	eea58593          	addi	a1,a1,-278 # 5c48 <malloc+0x492>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3e26:	79650513          	addi	a0,a0,1942 # 75b8 <malloc+0x1e02>
    3e2a:	00002097          	auipc	ra,0x2
    3e2e:	8ce080e7          	jalr	-1842(ra) # 56f8 <printf>
    exit(1);
    3e32:	4505                	li	a0,1
    ...
    3e42:	5d250513          	addi	a0,a0,1490 # 6410 <malloc+0xc5a>
    3e46:	00002097          	auipc	ra,0x2
    3e4a:	8b2080e7          	jalr	-1870(ra) # 56f8 <printf>
    exit(1);
    3e4e:	4505                	li	a0,1
    ...
    3e8c:	75050513          	addi	a0,a0,1872 # 75d8 <malloc+0x1e22>
    3e90:	00002097          	auipc	ra,0x2
    3e94:	868080e7          	jalr	-1944(ra) # 56f8 <printf>
    exit(1);
    3e98:	4505                	li	a0,1
...
0000000000003eac <reparent>:
{
  ...
  exit(0);
    ...
    3f00:	51450513          	addi	a0,a0,1300 # 6410 <malloc+0xc5a>
    3f04:	00001097          	auipc	ra,0x1
    3f08:	7f4080e7          	jalr	2036(ra) # 56f8 <printf>
      exit(1);
    3f0c:	4505                	li	a0,1
    ...
    3f1c:	68050513          	addi	a0,a0,1664 # 6598 <malloc+0xde2>
    3f20:	00001097          	auipc	ra,0x1
    3f24:	7d8080e7          	jalr	2008(ra) # 56f8 <printf>
        exit(1);
    3f28:	4505                	li	a0,1
...
0000000000003f5c <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3f84:	836080e7          	jalr	-1994(ra) # 57b6 <malloc>
    ...
    3fc4:	64850513          	addi	a0,a0,1608 # 7608 <malloc+0x1e52>
    3fc8:	00001097          	auipc	ra,0x1
    3fcc:	730080e7          	jalr	1840(ra) # 56f8 <printf>
      exit(1);
    3fd0:	4505                	li	a0,1
...
0000000000004002 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4098:	59450513          	addi	a0,a0,1428 # 7628 <malloc+0x1e72>
    409c:	00001097          	auipc	ra,0x1
    40a0:	65c080e7          	jalr	1628(ra) # 56f8 <printf>
    exit(1);
    40a4:	4505                	li	a0,1
    ...
    40b4:	5a050513          	addi	a0,a0,1440 # 7650 <malloc+0x1e9a>
    40b8:	00001097          	auipc	ra,0x1
    40bc:	640080e7          	jalr	1600(ra) # 56f8 <printf>
      exit(1);
    40c0:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    40f8:	92c50513          	addi	a0,a0,-1748 # 5a20 <malloc+0x26a>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4138:	53c50513          	addi	a0,a0,1340 # 7670 <malloc+0x1eba>
    413c:	00001097          	auipc	ra,0x1
    4140:	5bc080e7          	jalr	1468(ra) # 56f8 <printf>
    exit(1);
    4144:	4505                	li	a0,1
    ...
    4152:	fd2783e3          	beq	a5,s2,4118 <sharedfd+0x116>
      if(buf[i] == 'c')
    4156:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f18b0>
  ...
  unlink("sharedfd");
    ...
    4174:	8b050513          	addi	a0,a0,-1872 # 5a20 <malloc+0x26a>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    419a:	50250513          	addi	a0,a0,1282 # 7698 <malloc+0x1ee2>
    419e:	00001097          	auipc	ra,0x1
    41a2:	55a080e7          	jalr	1370(ra) # 56f8 <printf>
    exit(1);
    41a6:	4505                	li	a0,1
...
00000000000041ba <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    41de:	6c678793          	addi	a5,a5,1734 # 58a0 <malloc+0xea>
    41e2:	f6f43823          	sd	a5,-144(s0)
    41e6:	00001797          	auipc	a5,0x1
    41ea:	6c278793          	addi	a5,a5,1730 # 58a8 <malloc+0xf2>
    41ee:	f6f43c23          	sd	a5,-136(s0)
    41f2:	00001797          	auipc	a5,0x1
    41f6:	6be78793          	addi	a5,a5,1726 # 58b0 <malloc+0xfa>
    41fa:	f8f43023          	sd	a5,-128(s0)
    41fe:	00001797          	auipc	a5,0x1
    4202:	6ba78793          	addi	a5,a5,1722 # 58b8 <malloc+0x102>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    425c:	4e8a0a13          	addi	s4,s4,1256 # b740 <buf>
    4260:	00007a97          	auipc	s5,0x7
    4264:	4e1a8a93          	addi	s5,s5,1249 # b741 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    427a:	58a50513          	addi	a0,a0,1418 # 6800 <malloc+0x104a>
    427e:	00001097          	auipc	ra,0x1
    4282:	47a080e7          	jalr	1146(ra) # 56f8 <printf>
      exit(1);
    4286:	4505                	li	a0,1
    ...
    42f4:	3c050513          	addi	a0,a0,960 # 76b0 <malloc+0x1efa>
    42f8:	00001097          	auipc	ra,0x1
    42fc:	400080e7          	jalr	1024(ra) # 56f8 <printf>
        exit(1);
    4300:	4505                	li	a0,1
    ...
    430e:	3b650513          	addi	a0,a0,950 # 76c0 <malloc+0x1f0a>
    4312:	00001097          	auipc	ra,0x1
    4316:	3e6080e7          	jalr	998(ra) # 56f8 <printf>
          exit(1);
    431a:	4505                	li	a0,1
    ...
    4332:	3aa50513          	addi	a0,a0,938 # 76d8 <malloc+0x1f22>
    4336:	00001097          	auipc	ra,0x1
    433a:	3c2080e7          	jalr	962(ra) # 56f8 <printf>
          exit(1);
    433e:	4505                	li	a0,1
    ...
    4362:	3e278793          	addi	a5,a5,994 # b740 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    43c2:	32a50513          	addi	a0,a0,810 # 76e8 <malloc+0x1f32>
    43c6:	00001097          	auipc	ra,0x1
    43ca:	332080e7          	jalr	818(ra) # 56f8 <printf>
      exit(1);
    43ce:	4505                	li	a0,1
...
00000000000043f6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4424:	2e0b8b93          	addi	s7,s7,736 # 7700 <malloc+0x1f4a>
  for(i = 0; i < N; i++){
    ...
    4466:	2a650513          	addi	a0,a0,678 # 7708 <malloc+0x1f52>
    446a:	00001097          	auipc	ra,0x1
    446e:	28e080e7          	jalr	654(ra) # 56f8 <printf>
        exit(1);
    4472:	4505                	li	a0,1
    ...
    4484:	28050513          	addi	a0,a0,640 # 7700 <malloc+0x1f4a>
  ...
  fd = open(".", 0);
    ...
    44bc:	db850513          	addi	a0,a0,-584 # 6270 <malloc+0xaba>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    44e2:	24a50513          	addi	a0,a0,586 # 7728 <malloc+0x1f72>
    44e6:	00001097          	auipc	ra,0x1
    44ea:	212080e7          	jalr	530(ra) # 56f8 <printf>
        exit(1);
    44ee:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4552:	1fa50513          	addi	a0,a0,506 # 7748 <malloc+0x1f92>
    4556:	00001097          	auipc	ra,0x1
    455a:	1a2080e7          	jalr	418(ra) # 56f8 <printf>
        exit(1);
    455e:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    458a:	1ea50513          	addi	a0,a0,490 # 7770 <malloc+0x1fba>
    458e:	00001097          	auipc	ra,0x1
    4592:	16a080e7          	jalr	362(ra) # 56f8 <printf>
    exit(1);
    4596:	4505                	li	a0,1
    ...
    45a6:	e6e50513          	addi	a0,a0,-402 # 6410 <malloc+0xc5a>
    45aa:	00001097          	auipc	ra,0x1
    45ae:	14e080e7          	jalr	334(ra) # 56f8 <printf>
      exit(1);
    45b2:	4505                	li	a0,1
...
0000000000004750 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    47d8:	fd450513          	addi	a0,a0,-44 # 77a8 <malloc+0x1ff2>
  ...
  for(i = 0; ; i++){
    ...
    483c:	f8050513          	addi	a0,a0,-128 # 77b8 <malloc+0x2002>
    4840:	00001097          	auipc	ra,0x1
    4844:	eb8080e7          	jalr	-328(ra) # 56f8 <printf>
    exit(1);
    4848:	4505                	li	a0,1
    ...
    4858:	f8450513          	addi	a0,a0,-124 # 77d8 <malloc+0x2022>
    485c:	00001097          	auipc	ra,0x1
    4860:	e9c080e7          	jalr	-356(ra) # 56f8 <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    4874:	f8850513          	addi	a0,a0,-120 # 77f8 <malloc+0x2042>
    4878:	00001097          	auipc	ra,0x1
    487c:	e80080e7          	jalr	-384(ra) # 56f8 <printf>
    exit(1);
    4880:	4505                	li	a0,1
    ...
    4890:	f8c50513          	addi	a0,a0,-116 # 7818 <malloc+0x2062>
    4894:	00001097          	auipc	ra,0x1
    4898:	e64080e7          	jalr	-412(ra) # 56f8 <printf>
      exit(1);
    489c:	4505                	li	a0,1
    ...
    48ac:	f9050513          	addi	a0,a0,-112 # 7838 <malloc+0x2082>
    48b0:	00001097          	auipc	ra,0x1
    48b4:	e48080e7          	jalr	-440(ra) # 56f8 <printf>
      exit(1);
    48b8:	4505                	li	a0,1
    ...
    48c8:	f8c50513          	addi	a0,a0,-116 # 7850 <malloc+0x209a>
    48cc:	00001097          	auipc	ra,0x1
    48d0:	e2c080e7          	jalr	-468(ra) # 56f8 <printf>
      exit(1);
    48d4:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    48f6:	eb650513          	addi	a0,a0,-330 # 77a8 <malloc+0x1ff2>
    ...
    491a:	f5a50513          	addi	a0,a0,-166 # 7870 <malloc+0x20ba>
    491e:	00001097          	auipc	ra,0x1
    4922:	dda080e7          	jalr	-550(ra) # 56f8 <printf>
    exit(1);
    4926:	4505                	li	a0,1
...
0000000000004930 <dirtest>:
{
  ...
  printf("mkdir test\n");
    ...
    4940:	f5450513          	addi	a0,a0,-172 # 7890 <malloc+0x20da>
    4944:	00001097          	auipc	ra,0x1
    4948:	db4080e7          	jalr	-588(ra) # 56f8 <printf>
  if(mkdir("dir0") < 0){
    494c:	00003517          	auipc	a0,0x3
    4950:	f5450513          	addi	a0,a0,-172 # 78a0 <malloc+0x20ea>
  ...
  if(chdir("dir0") < 0){
    ...
    4964:	f4050513          	addi	a0,a0,-192 # 78a0 <malloc+0x20ea>
  ...
  if(chdir("..") < 0){
    ...
    4978:	98450513          	addi	a0,a0,-1660 # 72f8 <malloc+0x1b42>
  ...
  if(unlink("dir0") < 0){
    ...
    498c:	f1850513          	addi	a0,a0,-232 # 78a0 <malloc+0x20ea>
  ...
  printf("%s: mkdir test ok\n");
    ...
    49a0:	f5450513          	addi	a0,a0,-172 # 78f0 <malloc+0x213a>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	d54080e7          	jalr	-684(ra) # 56f8 <printf>
}
    ...
    49bc:	2e050513          	addi	a0,a0,736 # 6c98 <malloc+0x14e2>
    49c0:	00001097          	auipc	ra,0x1
    49c4:	d38080e7          	jalr	-712(ra) # 56f8 <printf>
    exit(1);
    49c8:	4505                	li	a0,1
    ...
    49d8:	ed450513          	addi	a0,a0,-300 # 78a8 <malloc+0x20f2>
    49dc:	00001097          	auipc	ra,0x1
    49e0:	d1c080e7          	jalr	-740(ra) # 56f8 <printf>
    exit(1);
    49e4:	4505                	li	a0,1
    ...
    49f4:	ed050513          	addi	a0,a0,-304 # 78c0 <malloc+0x210a>
    49f8:	00001097          	auipc	ra,0x1
    49fc:	d00080e7          	jalr	-768(ra) # 56f8 <printf>
    exit(1);
    4a00:	4505                	li	a0,1
    ...
    4a10:	ecc50513          	addi	a0,a0,-308 # 78d8 <malloc+0x2122>
    4a14:	00001097          	auipc	ra,0x1
    4a18:	ce4080e7          	jalr	-796(ra) # 56f8 <printf>
    exit(1);
    4a1c:	4505                	li	a0,1
...
0000000000004a26 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4a48:	ec450513          	addi	a0,a0,-316 # 7908 <malloc+0x2152>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	cac080e7          	jalr	-852(ra) # 56f8 <printf>
  for(nfiles = 0; ; nfiles++){
    4a54:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4a68:	eb4c8c93          	addi	s9,s9,-332 # 7918 <malloc+0x2162>
    int total = 0;
    4a6c:	4d81                	li	s11,0
    ...
    4ac0:	c3c080e7          	jalr	-964(ra) # 56f8 <printf>
    ...
    4ae2:	e4a50513          	addi	a0,a0,-438 # 7928 <malloc+0x2172>
    4ae6:	00001097          	auipc	ra,0x1
    4aea:	c12080e7          	jalr	-1006(ra) # 56f8 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4b58:	e0450513          	addi	a0,a0,-508 # 7958 <malloc+0x21a2>
    4b5c:	00001097          	auipc	ra,0x1
    4b60:	b9c080e7          	jalr	-1124(ra) # 56f8 <printf>
}
    ...
    4ba8:	d9c50513          	addi	a0,a0,-612 # 7940 <malloc+0x218a>
    4bac:	00001097          	auipc	ra,0x1
    4bb0:	b4c080e7          	jalr	-1204(ra) # 56f8 <printf>
    close(fd);
    4bb4:	854a                	mv	a0,s2
...
0000000000004bf6 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4c6a:	d0a50513          	addi	a0,a0,-758 # 7970 <malloc+0x21ba>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4c82:	fca58593          	addi	a1,a1,-54 # 5c48 <malloc+0x492>
    ...
    4c98:	cfc50513          	addi	a0,a0,-772 # 7990 <malloc+0x21da>
    4c9c:	00001097          	auipc	ra,0x1
    4ca0:	a5c080e7          	jalr	-1444(ra) # 56f8 <printf>
    exit(1);
    4ca4:	4505                	li	a0,1
    ...
    4cb2:	cca50513          	addi	a0,a0,-822 # 7978 <malloc+0x21c2>
    4cb6:	00001097          	auipc	ra,0x1
    4cba:	a42080e7          	jalr	-1470(ra) # 56f8 <printf>
      exit(1);
    4cbe:	4505                	li	a0,1
    ...
    4ccc:	cb050513          	addi	a0,a0,-848 # 7978 <malloc+0x21c2>
    4cd0:	00001097          	auipc	ra,0x1
    4cd4:	a28080e7          	jalr	-1496(ra) # 56f8 <printf>
    exit(1);
    4cd8:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    4cf0:	c8450513          	addi	a0,a0,-892 # 7970 <malloc+0x21ba>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4d46:	f0690913          	addi	s2,s2,-250 # 5c48 <malloc+0x492>
      uint64 a = (uint64) sbrk(4096);
    ...
    4d7a:	c6a50513          	addi	a0,a0,-918 # 79e0 <malloc+0x222a>
    4d7e:	00001097          	auipc	ra,0x1
    4d82:	97a080e7          	jalr	-1670(ra) # 56f8 <printf>
        exit(1);
    4d86:	4505                	li	a0,1
    ...
    4d94:	c1050513          	addi	a0,a0,-1008 # 79a0 <malloc+0x21ea>
    4d98:	00001097          	auipc	ra,0x1
    4d9c:	960080e7          	jalr	-1696(ra) # 56f8 <printf>
    exit(1);
    4da0:	4505                	li	a0,1
    ...
    4dae:	c1650513          	addi	a0,a0,-1002 # 79c0 <malloc+0x220a>
    4db2:	00001097          	auipc	ra,0x1
    4db6:	946080e7          	jalr	-1722(ra) # 56f8 <printf>
    exit(1);
    4dba:	4505                	li	a0,1
  ...
  while(1){
    ...
    4dfc:	c0850513          	addi	a0,a0,-1016 # 7a00 <malloc+0x224a>
    4e00:	00001097          	auipc	ra,0x1
    4e04:	8f8080e7          	jalr	-1800(ra) # 56f8 <printf>
      exit(1);
    4e08:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4e4c:	bd850513          	addi	a0,a0,-1064 # 7a20 <malloc+0x226a>
    4e50:	00001097          	auipc	ra,0x1
    4e54:	8a8080e7          	jalr	-1880(ra) # 56f8 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4e7c:	bd050513          	addi	a0,a0,-1072 # 7a48 <malloc+0x2292>
    4e80:	00001097          	auipc	ra,0x1
    4e84:	878080e7          	jalr	-1928(ra) # 56f8 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4ea0:	b9450513          	addi	a0,a0,-1132 # 7a30 <malloc+0x227a>
    4ea4:	00001097          	auipc	ra,0x1
    4ea8:	854080e7          	jalr	-1964(ra) # 56f8 <printf>
    exit(1);
    4eac:	4505                	li	a0,1
    ...
    4ec8:	b8c50513          	addi	a0,a0,-1140 # 7a50 <malloc+0x229a>
    4ecc:	00001097          	auipc	ra,0x1
    4ed0:	82c080e7          	jalr	-2004(ra) # 56f8 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    4f10:	c5c78793          	addi	a5,a5,-932 # 7b68 <malloc+0x23b2>
    4f14:	c4040713          	addi	a4,s0,-960
    4f18:	00003817          	auipc	a6,0x3
    4f1c:	fd080813          	addi	a6,a6,-48 # 7ee8 <malloc+0x2732>
  ...
  printf("usertests starting\n");
    ...
    4f40:	bcc50513          	addi	a0,a0,-1076 # 7b08 <malloc+0x2352>
    4f44:	00000097          	auipc	ra,0x0
    4f48:	7b4080e7          	jalr	1972(ra) # 56f8 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    4f78:	b4c50513          	addi	a0,a0,-1204 # 7ac0 <malloc+0x230a>
    4f7c:	00000097          	auipc	ra,0x0
    4f80:	77c080e7          	jalr	1916(ra) # 56f8 <printf>
    exit(1);
    4f84:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    4f94:	ac858593          	addi	a1,a1,-1336 # 7a58 <malloc+0x22a2>
    ...
    4faa:	b9a58593          	addi	a1,a1,-1126 # 7b40 <malloc+0x238a>
    ...
    4fce:	a9650513          	addi	a0,a0,-1386 # 7a60 <malloc+0x22aa>
    4fd2:	00000097          	auipc	ra,0x0
    4fd6:	726080e7          	jalr	1830(ra) # 56f8 <printf>
    exit(1);
    4fda:	4505                	li	a0,1
    ...
    4ff8:	704080e7          	jalr	1796(ra) # 56f8 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    503a:	a7250513          	addi	a0,a0,-1422 # 7aa8 <malloc+0x22f2>
    503e:	00000097          	auipc	ra,0x0
    5042:	6ba080e7          	jalr	1722(ra) # 56f8 <printf>
    exit(1);
    5046:	4505                	li	a0,1
    ...
    5054:	aa050513          	addi	a0,a0,-1376 # 7af0 <malloc+0x233a>
    5058:	00000097          	auipc	ra,0x0
    505c:	6a0080e7          	jalr	1696(ra) # 56f8 <printf>
    exit(0);
    5060:	4501                	li	a0,0
    ...
    5070:	68c080e7          	jalr	1676(ra) # 56f8 <printf>
        if(continuous != 2)
    ...
    50b2:	aba78793          	addi	a5,a5,-1350 # 7b68 <malloc+0x23b2>
    50b6:	c4040713          	addi	a4,s0,-960
    50ba:	00003817          	auipc	a6,0x3
    50be:	e2e80813          	addi	a6,a6,-466 # 7ee8 <malloc+0x2732>
    ...
    50e2:	a4250513          	addi	a0,a0,-1470 # 7b20 <malloc+0x236a>
    50e6:	00000097          	auipc	ra,0x0
    50ea:	612080e7          	jalr	1554(ra) # 56f8 <printf>
        printf("SOME TESTS FAILED\n");
    50ee:	00003a97          	auipc	s5,0x3
    50f2:	9baa8a93          	addi	s5,s5,-1606 # 7aa8 <malloc+0x22f2>
        if(continuous != 2)
    50f6:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    50f8:	00003b17          	auipc	s6,0x3
    50fc:	990b0b13          	addi	s6,s6,-1648 # 7a88 <malloc+0x22d2>
...
putc(int fd, char c)
{
    5420:	1101                	addi	sp,sp,-32
    5422:	ec06                	sd	ra,24(sp)
    5424:	e822                	sd	s0,16(sp)
    5426:	1000                	addi	s0,sp,32
    5428:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    542c:	4605                	li	a2,1
    542e:	fef40593          	addi	a1,s0,-17
    5432:	00000097          	auipc	ra,0x0
    5436:	f66080e7          	jalr	-154(ra) # 5398 <write>
}
    543a:	60e2                	ld	ra,24(sp)
    543c:	6442                	ld	s0,16(sp)
    543e:	6105                	addi	sp,sp,32
    5440:	8082                	ret

0000000000005442 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5442:	7139                	addi	sp,sp,-64
    5444:	fc06                	sd	ra,56(sp)
    5446:	f822                	sd	s0,48(sp)
    5448:	f426                	sd	s1,40(sp)
    544a:	f04a                	sd	s2,32(sp)
    544c:	ec4e                	sd	s3,24(sp)
    544e:	0080                	addi	s0,sp,64
    5450:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5452:	c299                	beqz	a3,5458 <printint+0x16>
    5454:	0805c863          	bltz	a1,54e4 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5458:	2581                	sext.w	a1,a1
  neg = 0;
    545a:	4881                	li	a7,0
    545c:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5462:	2601                	sext.w	a2,a2
    5464:	00003517          	auipc	a0,0x3
    5468:	a8c50513          	addi	a0,a0,-1396 # 7ef0 <digits>
    546c:	883a                	mv	a6,a4
    546e:	2705                	addiw	a4,a4,1
    5470:	02c5f7bb          	remuw	a5,a1,a2
    5474:	1782                	slli	a5,a5,0x20
    5476:	9381                	srli	a5,a5,0x20
    5478:	97aa                	add	a5,a5,a0
    547a:	0007c783          	lbu	a5,0(a5)
    547e:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5482:	0005879b          	sext.w	a5,a1
    5486:	02c5d5bb          	divuw	a1,a1,a2
    548a:	0685                	addi	a3,a3,1
    548c:	fec7f0e3          	bgeu	a5,a2,546c <printint+0x2a>
  if(neg)
    5490:	00088b63          	beqz	a7,54a6 <printint+0x64>
    buf[i++] = '-';
    5494:	fd040793          	addi	a5,s0,-48
    5498:	973e                	add	a4,a4,a5
    549a:	02d00793          	li	a5,45
    549e:	fef70823          	sb	a5,-16(a4)
    54a2:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    54a6:	02e05863          	blez	a4,54d6 <printint+0x94>
    54aa:	fc040793          	addi	a5,s0,-64
    54ae:	00e78933          	add	s2,a5,a4
    54b2:	fff78993          	addi	s3,a5,-1
    54b6:	99ba                	add	s3,s3,a4
    54b8:	377d                	addiw	a4,a4,-1
    54ba:	1702                	slli	a4,a4,0x20
    54bc:	9301                	srli	a4,a4,0x20
    54be:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    54c2:	fff94583          	lbu	a1,-1(s2)
    54c6:	8526                	mv	a0,s1
    54c8:	00000097          	auipc	ra,0x0
    54cc:	f58080e7          	jalr	-168(ra) # 5420 <putc>
  while(--i >= 0)
    54d0:	197d                	addi	s2,s2,-1
    54d2:	ff3918e3          	bne	s2,s3,54c2 <printint+0x80>
}
    54d6:	70e2                	ld	ra,56(sp)
    54d8:	7442                	ld	s0,48(sp)
    ...
    54e2:	8082                	ret
    x = -xx;
    54e4:	40b005bb          	negw	a1,a1
    neg = 1;
    54e8:	4885                	li	a7,1
    x = -xx;
    54ea:	bf8d                	j	545c <printint+0x1a>

00000000000054ec <vprintf>:
}
...
{
    54ec:	7119                	addi	sp,sp,-128
    54ee:	fc86                	sd	ra,120(sp)
    54f0:	f8a2                	sd	s0,112(sp)
    54f2:	f4a6                	sd	s1,104(sp)
    54f4:	f0ca                	sd	s2,96(sp)
    54f6:	ecce                	sd	s3,88(sp)
    54f8:	e8d2                	sd	s4,80(sp)
    54fa:	e4d6                	sd	s5,72(sp)
    54fc:	e0da                	sd	s6,64(sp)
    54fe:	fc5e                	sd	s7,56(sp)
    5500:	f862                	sd	s8,48(sp)
    5502:	f466                	sd	s9,40(sp)
    5504:	f06a                	sd	s10,32(sp)
    5506:	ec6e                	sd	s11,24(sp)
    5508:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    550a:	0005c903          	lbu	s2,0(a1)
    550e:	18090f63          	beqz	s2,56ac <vprintf+0x1c0>
    5512:	8aaa                	mv	s5,a0
    5514:	8b32                	mv	s6,a2
    5516:	00158493          	addi	s1,a1,1
  state = 0;
    551a:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    551c:	02500a13          	li	s4,37
      if(c == 'd'){
    5520:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5524:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5528:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    552c:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5530:	00003b97          	auipc	s7,0x3
    5534:	9c0b8b93          	addi	s7,s7,-1600 # 7ef0 <digits>
    5538:	a839                	j	5556 <vprintf+0x6a>
        putc(fd, c);
    553a:	85ca                	mv	a1,s2
    553c:	8556                	mv	a0,s5
    553e:	00000097          	auipc	ra,0x0
    5542:	ee2080e7          	jalr	-286(ra) # 5420 <putc>
    5546:	a019                	j	554c <vprintf+0x60>
    } else if(state == '%'){
    5548:	01498f63          	beq	s3,s4,5566 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    554c:	0485                	addi	s1,s1,1
    554e:	fff4c903          	lbu	s2,-1(s1)
    5552:	14090d63          	beqz	s2,56ac <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5556:	0009079b          	sext.w	a5,s2
    if(state == 0){
    555a:	fe0997e3          	bnez	s3,5548 <vprintf+0x5c>
      if(c == '%'){
    555e:	fd479ee3          	bne	a5,s4,553a <vprintf+0x4e>
        state = '%';
    5562:	89be                	mv	s3,a5
    5564:	b7e5                	j	554c <vprintf+0x60>
      if(c == 'd'){
    5566:	05878063          	beq	a5,s8,55a6 <vprintf+0xba>
      } else if(c == 'l') {
    556a:	05978c63          	beq	a5,s9,55c2 <vprintf+0xd6>
      } else if(c == 'x') {
    556e:	07a78863          	beq	a5,s10,55de <vprintf+0xf2>
      } else if(c == 'p') {
    5572:	09b78463          	beq	a5,s11,55fa <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5576:	07300713          	li	a4,115
    557a:	0ce78663          	beq	a5,a4,5646 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    557e:	06300713          	li	a4,99
    5582:	0ee78e63          	beq	a5,a4,567e <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5586:	11478863          	beq	a5,s4,5696 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5592:	e92080e7          	jalr	-366(ra) # 5420 <putc>
        putc(fd, c);
    5596:	85ca                	mv	a1,s2
    5598:	8556                	mv	a0,s5
    559a:	00000097          	auipc	ra,0x0
    559e:	e86080e7          	jalr	-378(ra) # 5420 <putc>
      }
      state = 0;
    55a2:	4981                	li	s3,0
    55a4:	b765                	j	554c <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    55a6:	008b0913          	addi	s2,s6,8
    55aa:	4685                	li	a3,1
    55ac:	4629                	li	a2,10
    55ae:	000b2583          	lw	a1,0(s6)
    55b2:	8556                	mv	a0,s5
    55b4:	00000097          	auipc	ra,0x0
    55b8:	e8e080e7          	jalr	-370(ra) # 5442 <printint>
    55bc:	8b4a                	mv	s6,s2
      state = 0;
    55be:	4981                	li	s3,0
    55c0:	b771                	j	554c <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    55c2:	008b0913          	addi	s2,s6,8
    55c6:	4681                	li	a3,0
    55c8:	4629                	li	a2,10
    55ca:	000b2583          	lw	a1,0(s6)
    55ce:	8556                	mv	a0,s5
    55d0:	00000097          	auipc	ra,0x0
    55d4:	e72080e7          	jalr	-398(ra) # 5442 <printint>
    55d8:	8b4a                	mv	s6,s2
      state = 0;
    55da:	4981                	li	s3,0
    55dc:	bf85                	j	554c <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    55f0:	e56080e7          	jalr	-426(ra) # 5442 <printint>
    55f4:	8b4a                	mv	s6,s2
      state = 0;
    55f6:	4981                	li	s3,0
    55f8:	bf91                	j	554c <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    55fa:	008b0793          	addi	a5,s6,8
    55fe:	f8f43423          	sd	a5,-120(s0)
    5602:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5606:	03000593          	li	a1,48
    560a:	8556                	mv	a0,s5
    560c:	00000097          	auipc	ra,0x0
    5610:	e14080e7          	jalr	-492(ra) # 5420 <putc>
  putc(fd, 'x');
    5614:	85ea                	mv	a1,s10
    5616:	8556                	mv	a0,s5
    5618:	00000097          	auipc	ra,0x0
    561c:	e08080e7          	jalr	-504(ra) # 5420 <putc>
    5620:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5622:	03c9d793          	srli	a5,s3,0x3c
    5626:	97de                	add	a5,a5,s7
    5628:	0007c583          	lbu	a1,0(a5)
    562c:	8556                	mv	a0,s5
    562e:	00000097          	auipc	ra,0x0
    5632:	df2080e7          	jalr	-526(ra) # 5420 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5636:	0992                	slli	s3,s3,0x4
    5638:	397d                	addiw	s2,s2,-1
    563a:	fe0914e3          	bnez	s2,5622 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    563e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5642:	4981                	li	s3,0
    5644:	b721                	j	554c <vprintf+0x60>
        s = va_arg(ap, char*);
    5646:	008b0993          	addi	s3,s6,8
    564a:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    564e:	02090163          	beqz	s2,5670 <vprintf+0x184>
        while(*s != 0){
    5652:	00094583          	lbu	a1,0(s2)
    5656:	c9a1                	beqz	a1,56a6 <vprintf+0x1ba>
          putc(fd, *s);
    5658:	8556                	mv	a0,s5
    565a:	00000097          	auipc	ra,0x0
    565e:	dc6080e7          	jalr	-570(ra) # 5420 <putc>
          s++;
    5662:	0905                	addi	s2,s2,1
        while(*s != 0){
    5664:	00094583          	lbu	a1,0(s2)
    5668:	f9e5                	bnez	a1,5658 <vprintf+0x16c>
        s = va_arg(ap, char*);
    566a:	8b4e                	mv	s6,s3
      state = 0;
    566c:	4981                	li	s3,0
    566e:	bdf9                	j	554c <vprintf+0x60>
          s = "(null)";
    5670:	00003917          	auipc	s2,0x3
    5674:	87890913          	addi	s2,s2,-1928 # 7ee8 <malloc+0x2732>
        while(*s != 0){
    5678:	02800593          	li	a1,40
    567c:	bff1                	j	5658 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    567e:	008b0913          	addi	s2,s6,8
    5682:	000b4583          	lbu	a1,0(s6)
    5686:	8556                	mv	a0,s5
    5688:	00000097          	auipc	ra,0x0
    568c:	d98080e7          	jalr	-616(ra) # 5420 <putc>
    5690:	8b4a                	mv	s6,s2
      state = 0;
    5692:	4981                	li	s3,0
    5694:	bd65                	j	554c <vprintf+0x60>
        putc(fd, c);
    5696:	85d2                	mv	a1,s4
    5698:	8556                	mv	a0,s5
    569a:	00000097          	auipc	ra,0x0
    569e:	d86080e7          	jalr	-634(ra) # 5420 <putc>
      state = 0;
    56a2:	4981                	li	s3,0
    56a4:	b565                	j	554c <vprintf+0x60>
        s = va_arg(ap, char*);
    56a6:	8b4e                	mv	s6,s3
      state = 0;
    56a8:	4981                	li	s3,0
    56aa:	b54d                	j	554c <vprintf+0x60>
    }
  }
}
    56ac:	70e6                	ld	ra,120(sp)
    56ae:	7446                	ld	s0,112(sp)
    56b0:	74a6                	ld	s1,104(sp)
    56b2:	7906                	ld	s2,96(sp)
    56b4:	69e6                	ld	s3,88(sp)
    56b6:	6a46                	ld	s4,80(sp)
    56b8:	6aa6                	ld	s5,72(sp)
    56ba:	6b06                	ld	s6,64(sp)
    56bc:	7be2                	ld	s7,56(sp)
    56be:	7c42                	ld	s8,48(sp)
    56c0:	7ca2                	ld	s9,40(sp)
    56c2:	7d02                	ld	s10,32(sp)
    56c4:	6de2                	ld	s11,24(sp)
    56c6:	6109                	addi	sp,sp,128
    56c8:	8082                	ret

00000000000056ca <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    56ca:	715d                	addi	sp,sp,-80
    56cc:	ec06                	sd	ra,24(sp)
    56ce:	e822                	sd	s0,16(sp)
    56d0:	1000                	addi	s0,sp,32
    56d2:	e010                	sd	a2,0(s0)
    56d4:	e414                	sd	a3,8(s0)
    56d6:	e818                	sd	a4,16(s0)
    56d8:	ec1c                	sd	a5,24(s0)
    56da:	03043023          	sd	a6,32(s0)
    56de:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    56e2:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    56e6:	8622                	mv	a2,s0
    56e8:	00000097          	auipc	ra,0x0
    56ec:	e04080e7          	jalr	-508(ra) # 54ec <vprintf>
}
    56f0:	60e2                	ld	ra,24(sp)
    56f2:	6442                	ld	s0,16(sp)
    56f4:	6161                	addi	sp,sp,80
    56f6:	8082                	ret

00000000000056f8 <printf>:

void
printf(const char *fmt, ...)
{
    56f8:	711d                	addi	sp,sp,-96
    56fa:	ec06                	sd	ra,24(sp)
    56fc:	e822                	sd	s0,16(sp)
    56fe:	1000                	addi	s0,sp,32
    5700:	e40c                	sd	a1,8(s0)
    5702:	e810                	sd	a2,16(s0)
    5704:	ec14                	sd	a3,24(s0)
    5706:	f018                	sd	a4,32(s0)
    5708:	f41c                	sd	a5,40(s0)
    570a:	03043823          	sd	a6,48(s0)
    570e:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5712:	00840613          	addi	a2,s0,8
    5716:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    571a:	85aa                	mv	a1,a0
    571c:	4505                	li	a0,1
    571e:	00000097          	auipc	ra,0x0
    5722:	dce080e7          	jalr	-562(ra) # 54ec <vprintf>
}
    5726:	60e2                	ld	ra,24(sp)
    5728:	6442                	ld	s0,16(sp)
    572a:	6125                	addi	sp,sp,96
    572c:	8082                	ret

000000000000572e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    5730:	e422                	sd	s0,8(sp)
    5732:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5734:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5738:	00002797          	auipc	a5,0x2
    573c:	7e87b783          	ld	a5,2024(a5) # 7f20 <freep>
    5740:	a805                	j	5770 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5742:	4618                	lw	a4,8(a2)
    5744:	9db9                	addw	a1,a1,a4
    5746:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    574a:	6398                	ld	a4,0(a5)
    574c:	6318                	ld	a4,0(a4)
    574e:	fee53823          	sd	a4,-16(a0)
    5752:	a091                	j	5796 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5754:	ff852703          	lw	a4,-8(a0)
    5758:	9e39                	addw	a2,a2,a4
    575a:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    575c:	ff053703          	ld	a4,-16(a0)
    5760:	e398                	sd	a4,0(a5)
    5762:	a099                	j	57a8 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5764:	6398                	ld	a4,0(a5)
    5766:	00e7e463          	bltu	a5,a4,576e <free+0x40>
    576a:	00e6ea63          	bltu	a3,a4,577e <free+0x50>
{
    576e:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5770:	fed7fae3          	bgeu	a5,a3,5764 <free+0x36>
    5774:	6398                	ld	a4,0(a5)
    5776:	00e6e463          	bltu	a3,a4,577e <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    577a:	fee7eae3          	bltu	a5,a4,576e <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    577e:	ff852583          	lw	a1,-8(a0)
    5782:	6390                	ld	a2,0(a5)
    5784:	02059713          	slli	a4,a1,0x20
    5788:	9301                	srli	a4,a4,0x20
    578a:	0712                	slli	a4,a4,0x4
    578c:	9736                	add	a4,a4,a3
    578e:	fae60ae3          	beq	a2,a4,5742 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5792:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5796:	4790                	lw	a2,8(a5)
    5798:	02061713          	slli	a4,a2,0x20
    579c:	9301                	srli	a4,a4,0x20
    579e:	0712                	slli	a4,a4,0x4
    57a0:	973e                	add	a4,a4,a5
    57a2:	fae689e3          	beq	a3,a4,5754 <free+0x26>
  } else
    p->s.ptr = bp;
    57a6:	e394                	sd	a3,0(a5)
  freep = p;
    57a8:	00002717          	auipc	a4,0x2
    57ac:	76f73c23          	sd	a5,1912(a4) # 7f20 <freep>
}
    57b0:	6422                	ld	s0,8(sp)
    57b2:	0141                	addi	sp,sp,16
    57b4:	8082                	ret

00000000000057b6 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    57b6:	7139                	addi	sp,sp,-64
    57b8:	fc06                	sd	ra,56(sp)
    57ba:	f822                	sd	s0,48(sp)
    57bc:	f426                	sd	s1,40(sp)
    57be:	f04a                	sd	s2,32(sp)
    57c0:	ec4e                	sd	s3,24(sp)
    57c2:	e852                	sd	s4,16(sp)
    57c4:	e456                	sd	s5,8(sp)
    57c6:	e05a                	sd	s6,0(sp)
    57c8:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    57ca:	02051493          	slli	s1,a0,0x20
    57ce:	9081                	srli	s1,s1,0x20
    57d0:	04bd                	addi	s1,s1,15
    57d2:	8091                	srli	s1,s1,0x4
    57d4:	0014899b          	addiw	s3,s1,1
    57d8:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    57da:	00002517          	auipc	a0,0x2
    57de:	74653503          	ld	a0,1862(a0) # 7f20 <freep>
    57e2:	c515                	beqz	a0,580e <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    57e4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    57e6:	4798                	lw	a4,8(a5)
    57e8:	02977f63          	bgeu	a4,s1,5826 <malloc+0x70>
    57ec:	8a4e                	mv	s4,s3
    57ee:	0009871b          	sext.w	a4,s3
    57f2:	6685                	lui	a3,0x1
    57f4:	00d77363          	bgeu	a4,a3,57fa <malloc+0x44>
    57f8:	6a05                	lui	s4,0x1
    57fa:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    57fe:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5802:	00002917          	auipc	s2,0x2
    5806:	71e90913          	addi	s2,s2,1822 # 7f20 <freep>
  if(p == (char*)-1)
    580a:	5afd                	li	s5,-1
    580c:	a88d                	j	587e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    580e:	00009797          	auipc	a5,0x9
    5812:	f3278793          	addi	a5,a5,-206 # e740 <base>
    5816:	00002717          	auipc	a4,0x2
    581a:	70f73523          	sd	a5,1802(a4) # 7f20 <freep>
    581e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5820:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5824:	b7e1                	j	57ec <malloc+0x36>
      if(p->s.size == nunits)
    5826:	02e48b63          	beq	s1,a4,585c <malloc+0xa6>
        p->s.size -= nunits;
    582a:	4137073b          	subw	a4,a4,s3
    582e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5830:	1702                	slli	a4,a4,0x20
    5832:	9301                	srli	a4,a4,0x20
    5834:	0712                	slli	a4,a4,0x4
    ...
    5860:	bff1                	j	583c <malloc+0x86>
  hp->s.size = nu;
    5862:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5866:	0541                	addi	a0,a0,16
    5868:	00000097          	auipc	ra,0x0
    586c:	ec6080e7          	jalr	-314(ra) # 572e <free>
  return freep;
    5870:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5874:	d971                	beqz	a0,5848 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5876:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5878:	4798                	lw	a4,8(a5)
    587a:	fa9776e3          	bgeu	a4,s1,5826 <malloc+0x70>
    if(p == freep)
    587e:	00093703          	ld	a4,0(s2)
    5882:	853e                	mv	a0,a5
    5884:	fef719e3          	bne	a4,a5,5876 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5888:	8552                	mv	a0,s4
    588a:	00000097          	auipc	ra,0x0
    588e:	b76080e7          	jalr	-1162(ra) # 5400 <sbrk>
  if(p == (char*)-1)
    5892:	fd5518e3          	bne	a0,s5,5862 <malloc+0xac>
        return 0;
    5896:	4501                	li	a0,0
    5898:	bf45                	j	5848 <malloc+0x92>
